...
from portone_server_sdk._generated.cash_receipt.cancel_cash_receipt_response import CancelCashReceiptResponse, _deserialize_cancel_cash_receipt_response, _serialize_cancel_cash_receipt_response
from portone_server_sdk._generated.cash_receipt.cash_receipt import CashReceipt, _deserialize_cash_receipt, _serialize_cash_receipt
from portone_server_sdk._generated.cash_receipt.cash_receipt_already_issued_error import CashReceiptAlreadyIssuedError, _deserialize_cash_receipt_already_issued_error, _serialize_cash_receipt_already_issued_error
from portone_server_sdk._generated.cash_receipt.cash_receipt_not_found_error import CashReceiptNotFoundError, _deserialize_cash_receipt_not_found_error, _serialize_cash_receipt_not_found_error
from portone_server_sdk._generated.cash_receipt.cash_receipt_not_issued_error import CashReceiptNotIssuedError, _deserialize_cash_receipt_not_issued_error, _serialize_cash_receipt_not_issued_error
...
from portone_server_sdk._generated.cash_receipt.issue_cash_receipt_customer_input import IssueCashReceiptCustomerInput, _deserialize_issue_cash_receipt_customer_input, _serialize_issue_cash_receipt_customer_input
from portone_server_sdk._generated.cash_receipt.issue_cash_receipt_response import IssueCashReceiptResponse, _deserialize_issue_cash_receipt_response, _serialize_issue_cash_receipt_response
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "CASH_RECEIPT_NOT_FOUND":
                raise errors.CashReceiptNotFoundError(_serialize_cash_receipt_not_found_error(error_response))
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "CASH_RECEIPT_ALREADY_ISSUED":
                raise errors.CashReceiptAlreadyIssuedError(_serialize_cash_receipt_already_issued_error(error_response))
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "CASH_RECEIPT_NOT_ISSUED":
                raise errors.CashReceiptNotIssuedError(_serialize_cash_receipt_not_issued_error(error_response))
            if error_type == "FORBIDDEN":
                raise errors.ForbiddenError(_serialize_forbidden_error(error_response))
            if error_type == "INVALID_REQUEST":
                raise errors.InvalidRequestError(_serialize_invalid_request_error(error_response))
