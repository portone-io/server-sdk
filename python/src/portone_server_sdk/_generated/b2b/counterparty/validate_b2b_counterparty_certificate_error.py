...
ValidateB2bCounterpartyCertificateError = Union[B2bCertificateUnregisteredError, B2bCounterpartyNotFoundError, B2bCounterpartyNtsNotConnectedError, B2bExternalServiceError, B2bNotEnabledError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_validate_b2b_counterparty_certificate_error(obj: ValidateB2bCounterpartyCertificateError) -> Any:
...
def _deserialize_validate_b2b_counterparty_certificate_error(obj: Any) -> ValidateB2bCounterpartyCertificateError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ValidateB2bCounterpartyCertificateError")
