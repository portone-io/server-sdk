...
@dataclass
class B2bCounterpartyContactInput:
    """거래처 담당자 입력 정보
    """
    name: str
    """담당자 성명
...
def _serialize_b2b_counterparty_contact_input(obj: B2bCounterpartyContactInput) -> Any:
...
def _deserialize_b2b_counterparty_contact_input(obj: Any) -> B2bCounterpartyContactInput:
    ...
    if "memo" in obj:
        ...
        memo = None
    return B2bCounterpartyContactInput(name, email, phone_number, memo)
