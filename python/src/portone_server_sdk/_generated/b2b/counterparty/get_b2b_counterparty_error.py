...
GetB2bCounterpartyError = Union[B2bCounterpartyNotFoundError, B2bExternalServiceError, B2bNotEnabledError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_get_b2b_counterparty_error(obj: GetB2bCounterpartyError) -> Any:
...
def _deserialize_get_b2b_counterparty_error(obj: Any) -> GetB2bCounterpartyError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bCounterpartyError")
