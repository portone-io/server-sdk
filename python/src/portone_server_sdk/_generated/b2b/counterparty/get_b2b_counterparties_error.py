...
GetB2bCounterpartiesError = Union[B2bExternalServiceError, B2bNotEnabledError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_get_b2b_counterparties_error(obj: GetB2bCounterpartiesError) -> Any:
...
def _deserialize_get_b2b_counterparties_error(obj: Any) -> GetB2bCounterpartiesError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bCounterpartiesError")
