...
GetB2bCounterpartyCertificateRegistrationUrlError = Union[B2bCounterpartyNotFoundError, B2bCounterpartyNtsNotConnectedError, B2bExternalServiceError, B2bNotEnabledError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_get_b2b_counterparty_certificate_registration_url_error(obj: GetB2bCounterpartyCertificateRegistrationUrlError) -> Any:
...
def _deserialize_get_b2b_counterparty_certificate_registration_url_error(obj: Any) -> GetB2bCounterpartyCertificateRegistrationUrlError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bCounterpartyCertificateRegistrationUrlError")
