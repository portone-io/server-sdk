...
@dataclass
class RequestB2bTaxInvoiceRequestBody:
    """세금계산서 역발행 요청 정보
    """
    brn: str
    """사업자등록번호
...
def _serialize_request_b2b_tax_invoice_request_body(obj: RequestB2bTaxInvoiceRequestBody) -> Any:
    entity = {}
    entity["brn"] = obj.brn
...
def _deserialize_request_b2b_tax_invoice_request_body(obj: Any) -> RequestB2bTaxInvoiceRequestBody:
    ...
    if "memo" in obj:
        ...
        memo = None
    return RequestB2bTaxInvoiceRequestBody(brn, document_key, document_key_type, memo)
