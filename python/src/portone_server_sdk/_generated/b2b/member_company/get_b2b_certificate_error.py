...
GetB2bCertificateError = Union[B2bCertificateUnregisteredError, B2bExternalServiceError, B2bMemberCompanyNotFoundError, B2bNotEnabledError, ForbiddenError, InvalidRequestError, UnauthorizedError]


def _serialize_get_b2b_certificate_error(obj: GetB2bCertificateError) -> Any:
...
def _deserialize_get_b2b_certificate_error(obj: Any) -> GetB2bCertificateError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bCertificateError")
