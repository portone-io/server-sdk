...
GetB2bCertificateRegistrationUrlError = Union[B2bExternalServiceError, B2bMemberCompanyNotFoundError, B2bNotEnabledError, ForbiddenError, InvalidRequestError, UnauthorizedError]


def _serialize_get_b2b_certificate_registration_url_error(obj: GetB2bCertificateRegistrationUrlError) -> Any:
...
def _deserialize_get_b2b_certificate_registration_url_error(obj: Any) -> GetB2bCertificateRegistrationUrlError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bCertificateRegistrationUrlError")
