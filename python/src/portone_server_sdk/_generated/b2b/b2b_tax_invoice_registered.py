...
def _serialize_b2b_tax_invoice_registered(obj: B2bTaxInvoiceRegistered) -> Any:
    entity = {}
...
def _deserialize_b2b_tax_invoice_registered(obj: Any) -> B2bTaxInvoiceRegistered:
