...
class B2bTaxInvoiceInput:
    ...
    최대 99개
    """
    contacts: Optional[list[B2bTaxInvoiceAdditionalContact]]
    """추가 담당자
...
def _deserialize_b2b_tax_invoice_input(obj: Any) -> B2bTaxInvoiceInput:
    ...
    if "contacts" in obj:
        ...
        contacts = None
    return B2bTaxInvoiceInput(tax_type, write_date, purpose_type, supply_cost_total_amount, tax_total_amount, total_amount, supplier, recipient, serial_num, book_volume, book_issue, cash_amount, check_amount, credit_amount, note_amount, remarks, supplier_document_key, recipient_document_key, send_sms, modification, items, contacts)
