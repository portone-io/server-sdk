...
UpdateB2bMemberCompanyContactError = Union[B2bContactNotFoundError, B2bExternalServiceError, B2bMemberCompanyNotFoundError, B2bNotEnabledError, InvalidRequestError, UnauthorizedError]


def _serialize_update_b2b_member_company_contact_error(obj: UpdateB2bMemberCompanyContactError) -> Any:
...
def _deserialize_update_b2b_member_company_contact_error(obj: Any) -> UpdateB2bMemberCompanyContactError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not UpdateB2bMemberCompanyContactError")
