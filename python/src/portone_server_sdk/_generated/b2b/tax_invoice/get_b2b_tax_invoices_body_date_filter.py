...
from ...b2b.tax_invoice.b2b_search_date_type import B2bSearchDateType, _deserialize_b2b_search_date_type, _serialize_b2b_search_date_type
from ...b2b.tax_invoice.date_range_option import DateRangeOption, _deserialize_date_range_option, _serialize_date_range_option

@dataclass
class GetB2bTaxInvoicesBodyDateFilter:
    """조회 기간 필터
    """
    date_type: Optional[B2bSearchDateType] = field(default=None)
    """조회 기간 기준

    미입력시 기본값은 등록일(`REGISTER`)로 설정됩니다.
    """
    date_range: Optional[list[DateRangeOption]] = field(default=None)
    """조회 기간
