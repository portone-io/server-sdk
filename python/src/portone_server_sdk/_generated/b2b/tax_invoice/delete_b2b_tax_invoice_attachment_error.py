...
from ...b2b.tax_invoice.b2b_tax_invoice_attachment_not_found_error import B2bTaxInvoiceAttachmentNotFoundError, _deserialize_b2b_tax_invoice_attachment_not_found_error, _serialize_b2b_tax_invoice_attachment_not_found_error
...
DeleteB2bTaxInvoiceAttachmentError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceAttachmentNotFoundError, B2bTaxInvoiceNotDraftedStatusError, B2bTaxInvoiceNotFoundError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]
...
def _serialize_delete_b2b_tax_invoice_attachment_error(obj: DeleteB2bTaxInvoiceAttachmentError) -> Any:
    ...
    if isinstance(obj, B2bTaxInvoiceAttachmentNotFoundError):
