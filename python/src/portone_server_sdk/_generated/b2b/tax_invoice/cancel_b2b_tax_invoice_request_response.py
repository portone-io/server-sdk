...
@dataclass
class CancelB2bTaxInvoiceRequestResponse:
    """세금계산서 역발행 요청 취소 응답
    """
    tax_invoice: B2bTaxInvoice


def _serialize_cancel_b2b_tax_invoice_request_response(obj: CancelB2bTaxInvoiceRequestResponse) -> Any:
...
def _deserialize_cancel_b2b_tax_invoice_request_response(obj: Any) -> CancelB2bTaxInvoiceRequestResponse:
    ...
    return CancelB2bTaxInvoiceRequestResponse(tax_invoice)
