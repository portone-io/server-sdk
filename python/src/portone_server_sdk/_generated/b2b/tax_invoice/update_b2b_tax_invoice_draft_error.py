...
UpdateB2bTaxInvoiceDraftError = Union[B2BCannotChangeTaxTypeError, B2bExternalServiceError, B2bIdAlreadyExistsError, B2bModificationNotProvidedError, B2bNotEnabledError, B2bOriginalTaxInvoiceNotFoundError, B2bRecipientNotFoundError, B2bSupplierNotFoundError, B2bTaxInvoiceNotDraftedStatusError, B2bTaxInvoiceNotFoundError, B2bTaxInvoiceRecipientDocumentKeyAlreadyUsedError, B2BTaxInvoiceStatusNotSendingCompletedError, B2bTaxInvoiceSupplierDocumentKeyAlreadyUsedError, ForbiddenError, InvalidRequestError, UnauthorizedError]
...
def _deserialize_update_b2b_tax_invoice_draft_error(obj: Any) -> UpdateB2bTaxInvoiceDraftError:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not UpdateB2bTaxInvoiceDraftError")
