...
from portone_server_sdk._generated.b2b.tax_invoice.b2b_tax_invoice_additional_contact import B2bTaxInvoiceAdditionalContact, _deserialize_b2b_tax_invoice_additional_contact, _serialize_b2b_tax_invoice_additional_contact
from portone_server_sdk._generated.b2b.tax_invoice.b2b_tax_invoice_company import B2bTaxInvoiceCompany, _deserialize_b2b_tax_invoice_company, _serialize_b2b_tax_invoice_company
from portone_server_sdk._generated.b2b.tax_invoice.b2b_tax_invoice_item import B2bTaxInvoiceItem, _deserialize_b2b_tax_invoice_item, _serialize_b2b_tax_invoice_item
...
class B2bTaxInvoiceInput:
    ...
    """
    items: Optional[list[B2bTaxInvoiceItem]]
    """품목

    최대 99개
    """
    additional_contacts: Optional[list[B2bTaxInvoiceAdditionalContact]]
    """추가 담당자
...
def _deserialize_b2b_tax_invoice_input(obj: Any) -> B2bTaxInvoiceInput:
    ...
    return B2bTaxInvoiceInput(taxation_type, write_date, purpose_type, total_supply_amount, total_tax_amount, total_amount, supplier, recipient, serial_number, book_volume, book_issue, cash_amount, check_amount, credit_amount, note_amount, remarks, supplier_document_key, recipient_document_key, send_sms, items, additional_contacts)
