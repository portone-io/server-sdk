...
AttachB2bTaxInvoiceFileError = Union[B2bExternalServiceError, B2bFileNotFoundError, B2bNotEnabledError, B2bTaxInvoiceNotDraftedStatusError, B2bTaxInvoiceNotFoundError, ForbiddenError, InvalidRequestError, UnauthorizedError]
...
def _serialize_attach_b2b_tax_invoice_file_error(obj: AttachB2bTaxInvoiceFileError) -> Any:
    ...
    if obj.type == "B2B_FILE_NOT_FOUND":
