...
DeleteB2bTaxInvoiceError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceNonDeletableStatusError, B2bTaxInvoiceNotFoundError, ForbiddenError, InvalidRequestError, UnauthorizedError]
...
def _serialize_delete_b2b_tax_invoice_error(obj: DeleteB2bTaxInvoiceError) -> Any:
    ...
    if obj.type == "B2B_TAX_INVOICE_NON_DELETABLE_STATUS":
