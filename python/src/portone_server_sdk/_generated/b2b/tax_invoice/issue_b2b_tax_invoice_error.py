...
IssueB2bTaxInvoiceError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceNotDraftedStatusError, B2bTaxInvoiceNotFoundError, B2bTaxInvoiceNotRequestedStatusError, B2bTaxInvoiceNoSupplierDocumentKeyError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_issue_b2b_tax_invoice_error(obj: IssueB2bTaxInvoiceError) -> Any:
...
def _deserialize_issue_b2b_tax_invoice_error(obj: Any) -> IssueB2bTaxInvoiceError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not IssueB2bTaxInvoiceError")
