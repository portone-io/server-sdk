...
from ...b2b.tax_invoice.b2b_tax_invoice_not_issued_status_error import B2bTaxInvoiceNotIssuedStatusError, _deserialize_b2b_tax_invoice_not_issued_status_error, _serialize_b2b_tax_invoice_not_issued_status_error
from ...common.forbidden_error import ForbiddenError, _deserialize_forbidden_error, _serialize_forbidden_error
from ...common.invalid_request_error import InvalidRequestError, _deserialize_invalid_request_error, _serialize_invalid_request_error
from ...common.unauthorized_error import UnauthorizedError, _deserialize_unauthorized_error, _serialize_unauthorized_error

CancelB2bTaxInvoiceIssuanceError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceNotFoundError, B2bTaxInvoiceNotIssuedStatusError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_cancel_b2b_tax_invoice_issuance_error(obj: CancelB2bTaxInvoiceIssuanceError) -> Any:
    ...
    if isinstance(obj, B2bTaxInvoiceNotIssuedStatusError):
...
def _deserialize_cancel_b2b_tax_invoice_issuance_error(obj: Any) -> CancelB2bTaxInvoiceIssuanceError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not CancelB2bTaxInvoiceIssuanceError")
