...
GetB2bTaxInvoicesError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceNotFoundError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_get_b2b_tax_invoices_error(obj: GetB2bTaxInvoicesError) -> Any:
...
def _deserialize_get_b2b_tax_invoices_error(obj: Any) -> GetB2bTaxInvoicesError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bTaxInvoicesError")
