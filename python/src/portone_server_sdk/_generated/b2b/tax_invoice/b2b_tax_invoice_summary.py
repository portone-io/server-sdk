...
from ...b2b.tax_invoice.b2b_company_state_business_status import B2bCompanyStateBusinessStatus, _deserialize_b2b_company_state_business_status, _serialize_b2b_company_state_business_status
...
class B2bTaxInvoiceSummary:
    ...
    """공급받는자 영업 상태
    """
    recipient_closed_suspended_date: Optional[str] = field(default=None)
    """공급받는자 휴폐업일자
    ...
    (RFC 3339 date-time)
    """
    opened_at: Optional[str] = field(default=None)
    """개봉 일시
    (RFC 3339 date-time)
    """
