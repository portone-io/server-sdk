...
GetB2bTaxInvoicePdfDownloadUrlError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceNotFoundError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_get_b2b_tax_invoice_pdf_download_url_error(obj: GetB2bTaxInvoicePdfDownloadUrlError) -> Any:
...
def _deserialize_get_b2b_tax_invoice_pdf_download_url_error(obj: Any) -> GetB2bTaxInvoicePdfDownloadUrlError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bTaxInvoicePdfDownloadUrlError")
