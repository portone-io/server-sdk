...
GetB2bTaxInvoiceError = Union[B2bExternalServiceError, B2bNotEnabledError, B2bTaxInvoiceNotFoundError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_get_b2b_tax_invoice_error(obj: GetB2bTaxInvoiceError) -> Any:
...
def _deserialize_get_b2b_tax_invoice_error(obj: Any) -> GetB2bTaxInvoiceError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bTaxInvoiceError")
