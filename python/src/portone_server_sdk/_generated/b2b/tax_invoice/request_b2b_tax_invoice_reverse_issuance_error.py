...
RequestB2bTaxInvoiceReverseIssuanceError = Union[B2BCannotChangeTaxTypeError, B2bExternalServiceError, B2bIdAlreadyExistsError, B2bIssuanceTypeMismatchError, B2bModificationNotProvidedError, B2bNotEnabledError, B2bOriginalTaxInvoiceNotFoundError, B2bRecipientNotFoundError, B2bSupplierNotFoundError, B2bTaxInvoiceNotFoundError, B2bTaxInvoiceRecipientDocumentKeyAlreadyUsedError, B2BTaxInvoiceStatusNotSendingCompletedError, B2bTaxInvoiceSupplierDocumentKeyAlreadyUsedError, ForbiddenError, InvalidRequestError, UnauthorizedError, dict]


def _serialize_request_b2b_tax_invoice_reverse_issuance_error(obj: RequestB2bTaxInvoiceReverseIssuanceError) -> Any:
...
def _deserialize_request_b2b_tax_invoice_reverse_issuance_error(obj: Any) -> RequestB2bTaxInvoiceReverseIssuanceError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not RequestB2bTaxInvoiceReverseIssuanceError")
