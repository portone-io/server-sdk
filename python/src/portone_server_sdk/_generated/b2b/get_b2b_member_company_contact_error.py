...
GetB2bMemberCompanyContactError = Union[B2bContactNotFoundError, B2bExternalServiceError, B2bMemberCompanyNotFoundError, B2bNotEnabledError, InvalidRequestError, UnauthorizedError]


def _serialize_get_b2b_member_company_contact_error(obj: GetB2bMemberCompanyContactError) -> Any:
...
def _deserialize_get_b2b_member_company_contact_error(obj: Any) -> GetB2bMemberCompanyContactError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetB2bMemberCompanyContactError")
