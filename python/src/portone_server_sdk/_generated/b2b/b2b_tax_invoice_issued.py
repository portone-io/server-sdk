...
def _serialize_b2b_tax_invoice_issued(obj: B2bTaxInvoiceIssued) -> Any:
    entity = {}
...
def _deserialize_b2b_tax_invoice_issued(obj: Any) -> B2bTaxInvoiceIssued:
