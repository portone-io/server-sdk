...
def _serialize_b2b_tax_invoice_requested(obj: B2bTaxInvoiceRequested) -> Any:
    entity = {}
...
def _deserialize_b2b_tax_invoice_requested(obj: Any) -> B2bTaxInvoiceRequested:
