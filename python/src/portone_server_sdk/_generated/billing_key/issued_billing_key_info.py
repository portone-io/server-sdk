...
from portone_server_sdk._generated.billing_key.billing_key_payment_method import BillingKeyPaymentMethod, _deserialize_billing_key_payment_method, _serialize_billing_key_payment_method
...
from portone_server_sdk._generated.billing_key.pg_billing_key_issue_response import PgBillingKeyIssueResponse, _deserialize_pg_billing_key_issue_response, _serialize_pg_billing_key_issue_response
...
def _deserialize_issued_billing_key_info(obj: Any) -> IssuedBillingKeyInfo:
    ...
    return IssuedBillingKeyInfo(status, billing_key, merchant_id, store_id, channels, customer, issued_at, methods, custom_data, issue_id, issue_name, requested_at, channel_group, pg_billing_key_issue_responses)
