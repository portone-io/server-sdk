...
from portone_server_sdk._generated.payment_schedule.already_paid_or_waiting_error import AlreadyPaidOrWaitingError as InternalAlreadyPaidOrWaitingError
...
from portone_server_sdk._generated.billing_key.billing_key_not_issued_error import BillingKeyNotIssuedError as InternalBillingKeyNotIssuedError
...
from portone_server_sdk._generated.cash_receipt.cash_receipt_already_issued_error import CashReceiptAlreadyIssuedError as InternalCashReceiptAlreadyIssuedError
from portone_server_sdk._generated.cash_receipt.cash_receipt_not_found_error import CashReceiptNotFoundError as InternalCashReceiptNotFoundError
from portone_server_sdk._generated.cash_receipt.cash_receipt_not_issued_error import CashReceiptNotIssuedError as InternalCashReceiptNotIssuedError
...
from portone_server_sdk._generated.billing_key.channel_specific_error import ChannelSpecificError as InternalChannelSpecificError
...
from portone_server_sdk._generated.payment_schedule.payment_schedule_already_processed_error import PaymentScheduleAlreadyProcessedError as InternalPaymentScheduleAlreadyProcessedError
from portone_server_sdk._generated.payment_schedule.payment_schedule_already_revoked_error import PaymentScheduleAlreadyRevokedError as InternalPaymentScheduleAlreadyRevokedError
from portone_server_sdk._generated.payment_schedule.payment_schedule_not_found_error import PaymentScheduleNotFoundError as InternalPaymentScheduleNotFoundError
...
from portone_server_sdk._generated.promotion.promotion_not_found_error import PromotionNotFoundError as InternalPromotionNotFoundError
...
from portone_server_sdk._generated.billing_key.channel_specific_failure import ChannelSpecificFailure
...
@dataclass
class B2bBankAccountNotFoundError(PortOneError):
    """계좌가 존재하지 않는 경우
    """
    _error: InitVar[InternalB2bBankAccountNotFoundError]

    def __post_init__(self, _error: InternalB2bBankAccountNotFoundError) -> None:
        self.message = _error.message

@dataclass
class B2bCertificateUnregisteredError(PortOneError):
    """인증서가 등록되어 있지 않은 경우
    """
    _error: InitVar[InternalB2bCertificateUnregisteredError]

    def __post_init__(self, _error: InternalB2bCertificateUnregisteredError) -> None:
        self.message = _error.message

@dataclass
class B2bCompanyAlreadyRegisteredError(PortOneError):
    """사업자가 이미 연동되어 있는 경우
    """
    _error: InitVar[InternalB2bCompanyAlreadyRegisteredError]

    def __post_init__(self, _error: InternalB2bCompanyAlreadyRegisteredError) -> None:
        self.message = _error.message

@dataclass
class B2bCompanyNotFoundError(PortOneError):
    """사업자가 존재하지 않는 경우
    """
    _error: InitVar[InternalB2bCompanyNotFoundError]

    def __post_init__(self, _error: InternalB2bCompanyNotFoundError) -> None:
        self.message = _error.message

@dataclass
class B2bContactNotFoundError(PortOneError):
    """담당자가 존재하지 않는 경우
    """
    _error: InitVar[InternalB2bContactNotFoundError]

    def __post_init__(self, _error: InternalB2bContactNotFoundError) -> None:
        self.message = _error.message

@dataclass
class B2bExternalServiceError(PortOneError):
    """외부 서비스에서 에러가 발생한 경우
    """
...
@dataclass
class B2bFileNotFoundError(PortOneError):
    """업로드한 파일을 찾을 수 없는 경우
    """
...
@dataclass
class B2bFinancialSystemCommunicationError(PortOneError):
    """금융기관과의 통신에 실패한 경우
    """
    _error: InitVar[InternalB2bFinancialSystemCommunicationError]

    def __post_init__(self, _error: InternalB2bFinancialSystemCommunicationError) -> None:
        self.message = _error.message

@dataclass
class B2bFinancialSystemFailureError(PortOneError):
    """금융기관 장애
    """
    _error: InitVar[InternalB2bFinancialSystemFailureError]

    def __post_init__(self, _error: InternalB2bFinancialSystemFailureError) -> None:
        self.message = _error.message

@dataclass
class B2bFinancialSystemUnderMaintenanceError(PortOneError):
    """금융기관 시스템이 점검 중인 경우
    """
    _error: InitVar[InternalB2bFinancialSystemUnderMaintenanceError]

    def __post_init__(self, _error: InternalB2bFinancialSystemUnderMaintenanceError) -> None:
        self.message = _error.message

@dataclass
class B2bForeignExchangeAccountError(PortOneError):
    """계좌 정보 조회가 불가능한 외화 계좌인 경우
    """
    _error: InitVar[InternalB2bForeignExchangeAccountError]

    def __post_init__(self, _error: InternalB2bForeignExchangeAccountError) -> None:
        self.message = _error.message

@dataclass
class B2bHometaxUnderMaintenanceError(PortOneError):
    """홈택스가 점검중이거나 순단이 발생한 경우
    """
    _error: InitVar[InternalB2bHometaxUnderMaintenanceError]

    def __post_init__(self, _error: InternalB2bHometaxUnderMaintenanceError) -> None:
        self.message = _error.message

@dataclass
class B2bIdAlreadyExistsError(PortOneError):
    """ID가 이미 사용중인 경우
    """
...
@dataclass
class B2bMemberCompanyNotFoundError(PortOneError):
    """연동 사업자가 존재하지 않는 경우
    """
    _error: InitVar[InternalB2bMemberCompanyNotFoundError]

    def __post_init__(self, _error: InternalB2bMemberCompanyNotFoundError) -> None:
        self.message = _error.message
...
@dataclass
class B2bRecipientNotFoundError(PortOneError):
    """공급받는자가 존재하지 않은 경우
    """
...
@dataclass
class B2bRegularMaintenanceTimeError(PortOneError):
    """금융기관 시스템이 정기 점검 중인 경우
    """
    _error: InitVar[InternalB2bRegularMaintenanceTimeError]

    def __post_init__(self, _error: InternalB2bRegularMaintenanceTimeError) -> None:
        self.message = _error.message

@dataclass
class B2bSupplierNotFoundError(PortOneError):
    """공급자가 존재하지 않은 경우
    """
...
@dataclass
class B2bSuspendedAccountError(PortOneError):
    """정지 계좌인 경우
    """
    _error: InitVar[InternalB2bSuspendedAccountError]

    def __post_init__(self, _error: InternalB2bSuspendedAccountError) -> None:
        self.message = _error.message

@dataclass
class B2bTaxInvoiceAttachmentNotFoundError(PortOneError):
...
@dataclass
class B2bTaxInvoiceNoRecipientDocumentKeyError(PortOneError):
...
@dataclass
class B2bTaxInvoiceNoSupplierDocumentKeyError(PortOneError):
...
@dataclass
class B2bTaxInvoiceNotFoundError(PortOneError):
    """세금계산서가 존재하지 않은 경우
    """
...
@dataclass
class B2bTaxInvoiceNotIssuedStatusError(PortOneError):
