...
from .platform.company.b2b_external_service_error import B2bExternalServiceError as InternalB2bExternalServiceError
from .platform.company.b2b_not_enabled_error import B2bNotEnabledError as InternalB2bNotEnabledError
...
@dataclass
class B2bExternalServiceError(GetB2bBusinessInfosError):
    """외부 서비스에서 에러가 발생한 경우
    """
...
@dataclass
class B2bNotEnabledError(GetB2bBusinessInfosError):
    """B2B 기능이 활성화되지 않은 경우
    """
