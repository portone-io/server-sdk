...
from .common.b2b_counterparty_not_found_error import B2bCounterpartyNotFoundError as InternalB2bCounterpartyNotFoundError
from .common.b2b_counterparty_nts_not_connected_error import B2bCounterpartyNtsNotConnectedError as InternalB2bCounterpartyNtsNotConnectedError
...
from .b2b.counterparty.b2b_certificate_unregistered_error import B2bCertificateUnregisteredError as InternalB2bCertificateUnregisteredError
from .b2b.counterparty.b2b_counterparty_ongoing_tax_invoice_exists_error import B2bCounterpartyOngoingTaxInvoiceExistsError as InternalB2bCounterpartyOngoingTaxInvoiceExistsError
from .b2b.counterparty.b2b_counterparty_partner_not_deletable_error import B2bCounterpartyPartnerNotDeletableError as InternalB2bCounterpartyPartnerNotDeletableError
from .b2b.counterparty.b2b_counterparty_brn_modification_not_allowed_error import B2bCounterpartyBrnModificationNotAllowedError as InternalB2bCounterpartyBrnModificationNotAllowedError
from .b2b.counterparty.b2b_counterparty_missing_required_fields_error import B2bCounterpartyMissingRequiredFieldsError as InternalB2bCounterpartyMissingRequiredFieldsError
from .b2b.counterparty.b2b_counterparty_partner_not_updatable_error import B2bCounterpartyPartnerNotUpdatableError as InternalB2bCounterpartyPartnerNotUpdatableError
from .b2b.counterparty.b2b_counterparty_too_many_additional_contacts_error import B2bCounterpartyTooManyAdditionalContactsError as InternalB2bCounterpartyTooManyAdditionalContactsError
from .b2b.counterparty.b2b_counterparty_verification_brn_mismatch_error import B2bCounterpartyVerificationBrnMismatchError as InternalB2bCounterpartyVerificationBrnMismatchError
from .b2b.counterparty.b2b_counterparty_verification_invalid_error import B2bCounterpartyVerificationInvalidError as InternalB2bCounterpartyVerificationInvalidError
from .b2b.counterparty.b2b_counterparty_verification_not_found_error import B2bCounterpartyVerificationNotFoundError as InternalB2bCounterpartyVerificationNotFoundError
from .b2b.counterparty.b2b_counterparty_verification_type_mismatch_error import B2bCounterpartyVerificationTypeMismatchError as InternalB2bCounterpartyVerificationTypeMismatchError
from .b2b.counterparty.b2b_counterparty_brn_invalid_error import B2bCounterpartyBrnInvalidError as InternalB2bCounterpartyBrnInvalidError
from .b2b.counterparty.b2b_counterparty_id_already_exists_error import B2bCounterpartyIdAlreadyExistsError as InternalB2bCounterpartyIdAlreadyExistsError
from .b2b.counterparty.b2b_counterparty_id_already_exists_by_partner_error import B2bCounterpartyIdAlreadyExistsByPartnerError as InternalB2bCounterpartyIdAlreadyExistsByPartnerError
from .b2b.counterparty.b2b_counterparty_nts_connection_failed_error import B2bCounterpartyNtsConnectionFailedError as InternalB2bCounterpartyNtsConnectionFailedError
from .b2b.counterparty.b2b_counterparty_partner_not_connectable_error import B2bCounterpartyPartnerNotConnectableError as InternalB2bCounterpartyPartnerNotConnectableError
from .b2b.counterparty.b2b_counterparty_self_origin_brn_mismatch_error import B2bCounterpartySelfOriginBrnMismatchError as InternalB2bCounterpartySelfOriginBrnMismatchError
...
from .platform.payout.platform_bulk_payout_id_already_exists_error import PlatformBulkPayoutIdAlreadyExistsError as InternalPlatformBulkPayoutIdAlreadyExistsError
from .platform.payout.platform_negative_payout_amount_partners_error import PlatformNegativePayoutAmountPartnersError as InternalPlatformNegativePayoutAmountPartnersError
from .platform.payout.platform_duplicated_partner_settlement_ids_error import PlatformDuplicatedPartnerSettlementIdsError as InternalPlatformDuplicatedPartnerSettlementIdsError
from .platform.payout.platform_non_payable_partner_settlements_error import PlatformNonPayablePartnerSettlementsError as InternalPlatformNonPayablePartnerSettlementsError
from .platform.payout.platform_no_selected_partner_settlements_error import PlatformNoSelectedPartnerSettlementsError as InternalPlatformNoSelectedPartnerSettlementsError
from .platform.platform_partner_settlements_not_found_error import PlatformPartnerSettlementsNotFoundError as InternalPlatformPartnerSettlementsNotFoundError
from .platform.partner_settlement.platform_non_deletable_partner_settlements_error import PlatformNonDeletablePartnerSettlementsError as InternalPlatformNonDeletablePartnerSettlementsError
from .platform.partner_settlement.platform_referenced_cancel_order_transfers_exist_error import PlatformReferencedCancelOrderTransfersExistError as InternalPlatformReferencedCancelOrderTransfersExistError
...
from .platform.partner.platform_archived_partner_nts_not_allowed_error import PlatformArchivedPartnerNtsNotAllowedError as InternalPlatformArchivedPartnerNtsNotAllowedError
...
from .platform.partner.platform_counterparty_not_connectable_status_error import PlatformCounterpartyNotConnectableStatusError as InternalPlatformCounterpartyNotConnectableStatusError
...
from .platform.partner.platform_counterparty_not_connected_error import PlatformCounterpartyNotConnectedError as InternalPlatformCounterpartyNotConnectedError
...
from .platform.partner.platform_counterparty_ongoing_tax_invoice_exists_error import PlatformCounterpartyOngoingTaxInvoiceExistsError as InternalPlatformCounterpartyOngoingTaxInvoiceExistsError
from .platform.partner.platform_partner_pending_nts_operation_error import PlatformPartnerPendingNtsOperationError as InternalPlatformPartnerPendingNtsOperationError
...
from .platform.transfer.platform_negative_amount_not_allowed_error import PlatformNegativeAmountNotAllowedError as InternalPlatformNegativeAmountNotAllowedError
from .platform.transfer.platform_transfer_id_already_used_error import PlatformTransferIdAlreadyUsedError as InternalPlatformTransferIdAlreadyUsedError
...
from .payment.max_cancel_count_reached_error import MaxCancelCountReachedError as InternalMaxCancelCountReachedError
...
from .common.payment_not_found_error import PaymentNotFoundError as InternalPaymentNotFoundError
...
from .payment.payment_cancellation_not_found_error import PaymentCancellationNotFoundError as InternalPaymentCancellationNotFoundError
from .payment.payment_cancellation_not_pending_error import PaymentCancellationNotPendingError as InternalPaymentCancellationNotPendingError
...
from .checkout_profile.profile_settings_not_found_error import ProfileSettingsNotFoundError as InternalProfileSettingsNotFoundError
...
from .payment_session.max_ttl_exceeded_error import MaxTtlExceededError as InternalMaxTtlExceededError
from .payment_session.session_expired_error import SessionExpiredError as InternalSessionExpiredError
from .payment_session.session_not_found_error import SessionNotFoundError as InternalSessionNotFoundError
...
from .b2b.counterparty.errors.create_b2b_counterparty_error import CreateB2bCounterpartyError
from .b2b.counterparty.errors.delete_b2b_counterparty_error import DeleteB2bCounterpartyError
from .b2b.counterparty.errors.get_b2b_counterparties_error import GetB2bCounterpartiesError
from .b2b.counterparty.errors.get_b2b_counterparty_certificate_error import GetB2bCounterpartyCertificateError
from .b2b.counterparty.errors.get_b2b_counterparty_certificate_registration_url_error import GetB2bCounterpartyCertificateRegistrationUrlError
from .b2b.counterparty.errors.get_b2b_counterparty_error import GetB2bCounterpartyError
from .b2b.counterparty.errors.update_b2b_counterparty_error import UpdateB2bCounterpartyError
from .b2b.counterparty.errors.validate_b2b_counterparty_certificate_error import ValidateB2bCounterpartyCertificateError
...
from .checkout_profile.errors.evaluate_checkout_profile_error import EvaluateCheckoutProfileError
...
from .payment.additional_feature.errors.get_pg_card_promotions_error import GetPgCardPromotionsError
...
from .payment.errors.stop_payment_cancellation_error import StopPaymentCancellationError
...
from .payment_session.errors.close_payment_session_error import ClosePaymentSessionError
from .payment_session.errors.create_payment_session_error import CreatePaymentSessionError
from .payment_session.errors.get_payment_session_error import GetPaymentSessionError
from .pg_specific.errors.confirm_paymentwall_delivery_error import ConfirmPaymentwallDeliveryError
...
from .platform.partner.errors.connect_bulk_partner_counterparty_error import ConnectBulkPartnerCounterpartyError
from .platform.partner.errors.connect_partner_counterparty_error import ConnectPartnerCounterpartyError
...
from .platform.partner.errors.disconnect_bulk_partner_counterparty_error import DisconnectBulkPartnerCounterpartyError
from .platform.partner.errors.disconnect_partner_counterparty_error import DisconnectPartnerCounterpartyError
...
from .platform.partner_settlement.errors.delete_platform_partner_settlements_error import DeletePlatformPartnerSettlementsError
from .platform.partner_settlement.errors.get_platform_partner_settlements_error import GetPlatformPartnerSettlementsError
from .platform.payout.errors.complete_platform_payout_by_partner_settlement_ids_error import CompletePlatformPayoutByPartnerSettlementIdsError
...
from .reconciliation.errors.get_payment_reconciliation_settlement_vat_report_error import GetPaymentReconciliationSettlementVatReportError
from .reconciliation.errors.get_payment_reconciliation_transaction_vat_report_error import GetPaymentReconciliationTransactionVatReportError
...
@dataclass
class B2bExternalServiceError(AttachB2bTaxInvoiceFileError, CancelB2bTaxInvoiceIssuanceError, CancelB2bTaxInvoiceRequestError, CreateB2bCounterpartyError, CreateB2bFileUploadUrlError, DeleteB2bCounterpartyError, DeleteB2bTaxInvoiceAttachmentError, DeleteB2bTaxInvoiceError, DraftB2bTaxInvoiceError, GetB2bBulkTaxInvoiceError, GetB2bBusinessInfosError, GetB2bCounterpartiesError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, GetB2bCounterpartyError, GetB2bTaxInvoiceAttachmentsError, GetB2bTaxInvoiceError, GetB2bTaxInvoicePdfDownloadUrlError, GetB2bTaxInvoicePopupUrlError, GetB2bTaxInvoicePrintUrlError, GetB2bTaxInvoicesError, IssueB2bTaxInvoiceError, IssueB2bTaxInvoiceImmediatelyError, RefuseB2bTaxInvoiceRequestError, RequestB2bTaxInvoiceReverseIssuanceError, SendToNtsB2bTaxInvoiceError, UpdateB2bCounterpartyError, UpdateB2bTaxInvoiceDraftError, ValidateB2bCounterpartyCertificateError, requestB2bTaxInvoiceError):
    """외부 서비스에서 에러가 발생한 경우
    """
...
@dataclass
class B2bNotEnabledError(AttachB2bTaxInvoiceFileError, CancelB2bTaxInvoiceIssuanceError, CancelB2bTaxInvoiceRequestError, CreateB2bCounterpartyError, CreateB2bFileUploadUrlError, DeleteB2bCounterpartyError, DeleteB2bTaxInvoiceAttachmentError, DeleteB2bTaxInvoiceError, DraftB2bTaxInvoiceError, GetB2bBulkTaxInvoiceError, GetB2bBusinessInfosError, GetB2bCounterpartiesError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, GetB2bCounterpartyError, GetB2bTaxInvoiceAttachmentsError, GetB2bTaxInvoiceError, GetB2bTaxInvoicePdfDownloadUrlError, GetB2bTaxInvoicePopupUrlError, GetB2bTaxInvoicePrintUrlError, GetB2bTaxInvoicesError, IssueB2bTaxInvoiceError, IssueB2bTaxInvoiceImmediatelyError, RefuseB2bTaxInvoiceRequestError, RequestB2bTaxInvoiceReverseIssuanceError, SendToNtsB2bTaxInvoiceError, UpdateB2bCounterpartyError, UpdateB2bTaxInvoiceDraftError, ValidateB2bCounterpartyCertificateError, requestB2bTaxInvoiceError):
    """B2B 기능이 활성화되지 않은 경우
    """
...
@dataclass
class InvalidRequestError(ApplyEscrowLogisticsError, ArchivePlatformAdditionalFeePolicyError, ArchivePlatformContractError, ArchivePlatformDiscountSharePolicyError, ArchivePlatformPartnerError, AttachB2bTaxInvoiceFileError, CancelB2bTaxInvoiceIssuanceError, CancelB2bTaxInvoiceRequestError, CancelCashReceiptError, CancelPaymentError, CancelPlatformAdditionalFeePolicyScheduleError, CancelPlatformContractScheduleError, CancelPlatformDiscountSharePolicyScheduleError, CancelPlatformPartnerScheduleError, CapturePaymentError, ClosePaymentSessionError, CloseVirtualAccountError, CompletePlatformPayoutByPartnerSettlementIdsError, ConfirmBillingKeyError, ConfirmBillingKeyIssueAndPayError, ConfirmEscrowError, ConfirmIdentityVerificationError, ConfirmPaymentError, ConfirmPaymentwallDeliveryError, ConnectBulkPartnerCounterpartyError, ConnectPartnerCounterpartyError, CreateB2bCounterpartyError, CreateB2bFileUploadUrlError, CreatePaymentScheduleError, CreatePaymentSessionError, CreatePlatformAdditionalFeePolicyError, CreatePlatformContractError, CreatePlatformDiscountSharePolicyError, CreatePlatformManualTransferError, CreatePlatformOrderCancelTransferError, CreatePlatformOrderTransferError, CreatePlatformPartnerError, CreatePlatformPartnersError, DeleteB2bCounterpartyError, DeleteB2bTaxInvoiceAttachmentError, DeleteB2bTaxInvoiceError, DeleteBillingKeyError, DeletePlatformPartnerSettlementsError, DeletePlatformTransferError, DisconnectBulkPartnerCounterpartyError, DisconnectPartnerCounterpartyError, DownloadB2bTaxInvoicesSheetError, DownloadPlatformTransferSheetError, DraftB2bTaxInvoiceError, EvaluateCheckoutProfileError, GetAllPaymentEventsError, GetAllPaymentsError, GetB2bBulkTaxInvoiceError, GetB2bBusinessInfosError, GetB2bCounterpartiesError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, GetB2bCounterpartyError, GetB2bTaxInvoiceAttachmentsError, GetB2bTaxInvoiceError, GetB2bTaxInvoicePdfDownloadUrlError, GetB2bTaxInvoicePopupUrlError, GetB2bTaxInvoicePrintUrlError, GetB2bTaxInvoicesError, GetBillingKeyInfoError, GetBillingKeyInfosError, GetCashReceiptError, GetCashReceiptsError, GetIdentityVerificationError, GetIdentityVerificationsError, GetKakaopayPaymentOrderError, GetPaymentError, GetPaymentReconciliationSettlementVatReportError, GetPaymentReconciliationTransactionVatReportError, GetPaymentScheduleError, GetPaymentSchedulesError, GetPaymentSessionError, GetPaymentTransactionsError, GetPaymentsError, GetPgCardPromotionsError, GetPlatformAccountHolderError, GetPlatformAccountTransfersError, GetPlatformAdditionalFeePoliciesError, GetPlatformAdditionalFeePolicyError, GetPlatformAdditionalFeePolicyScheduleError, GetPlatformBulkAccountTransfersError, GetPlatformBulkPayoutsError, GetPlatformCompanyStateError, GetPlatformContractError, GetPlatformContractScheduleError, GetPlatformContractsError, GetPlatformDiscountSharePoliciesError, GetPlatformDiscountSharePolicyError, GetPlatformDiscountSharePolicyFilterOptionsError, GetPlatformDiscountSharePolicyScheduleError, GetPlatformPartnerError, GetPlatformPartnerFilterOptionsError, GetPlatformPartnerScheduleError, GetPlatformPartnerSettlementsError, GetPlatformPartnersError, GetPlatformPayoutsError, GetPlatformSettingError, GetPlatformTransferError, GetPlatformTransferSummariesError, GetPromotionError, IssueB2bTaxInvoiceError, IssueB2bTaxInvoiceImmediatelyError, IssueBillingKeyError, IssueCashReceiptError, LoginViaApiSecretError, ModifyEscrowLogisticsError, PayInstantlyError, PayWithBillingKeyError, PreRegisterPaymentError, RecoverPlatformAdditionalFeePolicyError, RecoverPlatformContractError, RecoverPlatformDiscountSharePolicyError, RecoverPlatformPartnerError, RefreshTokenError, RefuseB2bTaxInvoiceRequestError, RegisterStoreReceiptError, RequestB2bTaxInvoiceReverseIssuanceError, RescheduleAdditionalFeePolicyError, RescheduleContractError, RescheduleDiscountSharePolicyError, ReschedulePartnerError, ResendIdentityVerificationError, ResendWebhookError, RevokePaymentSchedulesError, ScheduleAdditionalFeePolicyError, ScheduleContractError, ScheduleDiscountSharePolicyError, SchedulePartnerError, SchedulePlatformPartnersError, SendIdentityVerificationError, SendToNtsB2bTaxInvoiceError, StopPaymentCancellationError, UpdateB2bCounterpartyError, UpdateB2bTaxInvoiceDraftError, UpdatePlatformAdditionalFeePolicyError, UpdatePlatformContractError, UpdatePlatformDiscountSharePolicyError, UpdatePlatformPartnerError, UpdatePlatformSettingError, ValidateB2bCounterpartyCertificateError, requestB2bTaxInvoiceError):
...
@dataclass
class UnauthorizedError(ApplyEscrowLogisticsError, ArchivePlatformAdditionalFeePolicyError, ArchivePlatformContractError, ArchivePlatformDiscountSharePolicyError, ArchivePlatformPartnerError, AttachB2bTaxInvoiceFileError, CancelB2bTaxInvoiceIssuanceError, CancelB2bTaxInvoiceRequestError, CancelCashReceiptError, CancelPaymentError, CancelPlatformAdditionalFeePolicyScheduleError, CancelPlatformContractScheduleError, CancelPlatformDiscountSharePolicyScheduleError, CancelPlatformPartnerScheduleError, CapturePaymentError, ClosePaymentSessionError, CloseVirtualAccountError, CompletePlatformPayoutByPartnerSettlementIdsError, ConfirmBillingKeyError, ConfirmBillingKeyIssueAndPayError, ConfirmEscrowError, ConfirmIdentityVerificationError, ConfirmPaymentError, ConfirmPaymentwallDeliveryError, ConnectBulkPartnerCounterpartyError, ConnectPartnerCounterpartyError, CreateB2bCounterpartyError, CreateB2bFileUploadUrlError, CreatePaymentScheduleError, CreatePaymentSessionError, CreatePlatformAdditionalFeePolicyError, CreatePlatformContractError, CreatePlatformDiscountSharePolicyError, CreatePlatformManualTransferError, CreatePlatformOrderCancelTransferError, CreatePlatformOrderTransferError, CreatePlatformPartnerError, CreatePlatformPartnersError, DeleteB2bCounterpartyError, DeleteB2bTaxInvoiceAttachmentError, DeleteB2bTaxInvoiceError, DeleteBillingKeyError, DeletePlatformPartnerSettlementsError, DeletePlatformTransferError, DisconnectBulkPartnerCounterpartyError, DisconnectPartnerCounterpartyError, DownloadB2bTaxInvoicesSheetError, DownloadPlatformTransferSheetError, DraftB2bTaxInvoiceError, GetAllPaymentEventsError, GetAllPaymentsError, GetB2bBulkTaxInvoiceError, GetB2bBusinessInfosError, GetB2bCounterpartiesError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, GetB2bCounterpartyError, GetB2bTaxInvoiceAttachmentsError, GetB2bTaxInvoiceError, GetB2bTaxInvoicePdfDownloadUrlError, GetB2bTaxInvoicePopupUrlError, GetB2bTaxInvoicePrintUrlError, GetB2bTaxInvoicesError, GetBillingKeyInfoError, GetBillingKeyInfosError, GetCashReceiptError, GetCashReceiptsError, GetIdentityVerificationError, GetIdentityVerificationsError, GetKakaopayPaymentOrderError, GetPaymentError, GetPaymentReconciliationSettlementVatReportError, GetPaymentReconciliationTransactionVatReportError, GetPaymentScheduleError, GetPaymentSchedulesError, GetPaymentTransactionsError, GetPaymentsError, GetPgCardPromotionsError, GetPlatformAccountHolderError, GetPlatformAccountTransfersError, GetPlatformAdditionalFeePoliciesError, GetPlatformAdditionalFeePolicyError, GetPlatformAdditionalFeePolicyScheduleError, GetPlatformBulkAccountTransfersError, GetPlatformBulkPayoutsError, GetPlatformCompanyStateError, GetPlatformContractError, GetPlatformContractScheduleError, GetPlatformContractsError, GetPlatformDiscountSharePoliciesError, GetPlatformDiscountSharePolicyError, GetPlatformDiscountSharePolicyFilterOptionsError, GetPlatformDiscountSharePolicyScheduleError, GetPlatformPartnerError, GetPlatformPartnerFilterOptionsError, GetPlatformPartnerScheduleError, GetPlatformPartnerSettlementsError, GetPlatformPartnersError, GetPlatformPayoutsError, GetPlatformSettingError, GetPlatformTransferError, GetPlatformTransferSummariesError, GetPromotionError, IssueB2bTaxInvoiceError, IssueB2bTaxInvoiceImmediatelyError, IssueBillingKeyError, IssueCashReceiptError, LoginViaApiSecretError, ModifyEscrowLogisticsError, PayInstantlyError, PayWithBillingKeyError, PreRegisterPaymentError, RecoverPlatformAdditionalFeePolicyError, RecoverPlatformContractError, RecoverPlatformDiscountSharePolicyError, RecoverPlatformPartnerError, RefreshTokenError, RefuseB2bTaxInvoiceRequestError, RegisterStoreReceiptError, RequestB2bTaxInvoiceReverseIssuanceError, RescheduleAdditionalFeePolicyError, RescheduleContractError, RescheduleDiscountSharePolicyError, ReschedulePartnerError, ResendIdentityVerificationError, ResendWebhookError, RevokePaymentSchedulesError, ScheduleAdditionalFeePolicyError, ScheduleContractError, ScheduleDiscountSharePolicyError, SchedulePartnerError, SchedulePlatformPartnersError, SendIdentityVerificationError, SendToNtsB2bTaxInvoiceError, StopPaymentCancellationError, UpdateB2bCounterpartyError, UpdateB2bTaxInvoiceDraftError, UpdatePlatformAdditionalFeePolicyError, UpdatePlatformContractError, UpdatePlatformDiscountSharePolicyError, UpdatePlatformPartnerError, UpdatePlatformSettingError, ValidateB2bCounterpartyCertificateError, requestB2bTaxInvoiceError):
    """인증 정보가 올바르지 않은 경우
    """
...
@dataclass
class B2bCounterpartyNotFoundError(DeleteB2bCounterpartyError, DraftB2bTaxInvoiceError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, GetB2bCounterpartyError, IssueB2bTaxInvoiceImmediatelyError, RequestB2bTaxInvoiceReverseIssuanceError, UpdateB2bCounterpartyError, UpdateB2bTaxInvoiceDraftError, ValidateB2bCounterpartyCertificateError):
    """거래처가 존재하지 않는 경우
    """
    counterparty_id: Optional[str] = field(init=False)
    _error: InitVar[InternalB2bCounterpartyNotFoundError]

    def __post_init__(self, _error: InternalB2bCounterpartyNotFoundError) -> None:
        self.message = _error.message
        self.counterparty_id = _error.counterparty_id

@dataclass
class B2bCounterpartyNtsNotConnectedError(DraftB2bTaxInvoiceError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, IssueB2bTaxInvoiceImmediatelyError, RequestB2bTaxInvoiceReverseIssuanceError, UpdateB2bTaxInvoiceDraftError, ValidateB2bCounterpartyCertificateError):
    """국세청에 연동되어 있지 않은 경우
    """
    brn: Optional[str] = field(init=False)
    counterparty_id: Optional[str] = field(init=False)
    _error: InitVar[InternalB2bCounterpartyNtsNotConnectedError]

    def __post_init__(self, _error: InternalB2bCounterpartyNtsNotConnectedError) -> None:
        self.message = _error.message
        self.brn = _error.brn
        self.counterparty_id = _error.counterparty_id
...
@dataclass
class B2bCertificateUnregisteredError(GetB2bCounterpartyCertificateError, ValidateB2bCounterpartyCertificateError):
    """인증서가 등록되어 있지 않은 경우
    """
...
@dataclass
class B2bCounterpartyOngoingTaxInvoiceExistsError(DeleteB2bCounterpartyError):
    """진행 중인 세금계산서가 존재하여 거래처를 삭제할 수 없는 경우
    """
    _error: InitVar[InternalB2bCounterpartyOngoingTaxInvoiceExistsError]

    def __post_init__(self, _error: InternalB2bCounterpartyOngoingTaxInvoiceExistsError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyPartnerNotDeletableError(DeleteB2bCounterpartyError):
    """파트너 연동 거래처는 삭제할 수 없는 경우

    파트너와 연동된 거래처는 직접 삭제할 수 없습니다.
    """
    _error: InitVar[InternalB2bCounterpartyPartnerNotDeletableError]

    def __post_init__(self, _error: InternalB2bCounterpartyPartnerNotDeletableError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyBrnModificationNotAllowedError(UpdateB2bCounterpartyError):
    """사업자등록번호 수정이 허용되지 않는 경우

    거래처의 사업자등록번호는 수정할 수 없습니다.
    """
    _error: InitVar[InternalB2bCounterpartyBrnModificationNotAllowedError]

    def __post_init__(self, _error: InternalB2bCounterpartyBrnModificationNotAllowedError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyMissingRequiredFieldsError(CreateB2bCounterpartyError, UpdateB2bCounterpartyError):
    """필수 입력 항목이 누락된 경우

    거래처 생성/수정 시 필수 입력 항목이 누락되었습니다.
    """
    _error: InitVar[InternalB2bCounterpartyMissingRequiredFieldsError]

    def __post_init__(self, _error: InternalB2bCounterpartyMissingRequiredFieldsError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyPartnerNotUpdatableError(UpdateB2bCounterpartyError):
    """파트너 연동 거래처는 수정할 수 없는 경우

    파트너와 연동된 거래처는 직접 수정할 수 없습니다.
    """
    _error: InitVar[InternalB2bCounterpartyPartnerNotUpdatableError]

    def __post_init__(self, _error: InternalB2bCounterpartyPartnerNotUpdatableError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyTooManyAdditionalContactsError(CreateB2bCounterpartyError, UpdateB2bCounterpartyError):
    """추가 담당자가 너무 많은 경우

    추가 담당자는 최대 5명까지 등록할 수 있습니다.
    """
    _error: InitVar[InternalB2bCounterpartyTooManyAdditionalContactsError]

    def __post_init__(self, _error: InternalB2bCounterpartyTooManyAdditionalContactsError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyVerificationBrnMismatchError(CreateB2bCounterpartyError, UpdateB2bCounterpartyError):
    """검증 결과의 사업자등록번호가 일치하지 않는 경우
    """
    _error: InitVar[InternalB2bCounterpartyVerificationBrnMismatchError]

    def __post_init__(self, _error: InternalB2bCounterpartyVerificationBrnMismatchError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyVerificationInvalidError(CreateB2bCounterpartyError, UpdateB2bCounterpartyError):
    """검증 결과가 유효하지 않은 경우
    """
    _error: InitVar[InternalB2bCounterpartyVerificationInvalidError]

    def __post_init__(self, _error: InternalB2bCounterpartyVerificationInvalidError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyVerificationNotFoundError(CreateB2bCounterpartyError, UpdateB2bCounterpartyError):
    """검증 결과를 찾을 수 없는 경우

    사업자 정보 검증 결과를 찾을 수 없습니다.
    """
    _error: InitVar[InternalB2bCounterpartyVerificationNotFoundError]

    def __post_init__(self, _error: InternalB2bCounterpartyVerificationNotFoundError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyVerificationTypeMismatchError(CreateB2bCounterpartyError, UpdateB2bCounterpartyError):
    """검증 유형이 일치하지 않는 경우
    """
    _error: InitVar[InternalB2bCounterpartyVerificationTypeMismatchError]

    def __post_init__(self, _error: InternalB2bCounterpartyVerificationTypeMismatchError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyBrnInvalidError(CreateB2bCounterpartyError):
    """사업자등록번호가 유효하지 않은 경우
    """
    _error: InitVar[InternalB2bCounterpartyBrnInvalidError]

    def __post_init__(self, _error: InternalB2bCounterpartyBrnInvalidError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyIdAlreadyExistsError(CreateB2bCounterpartyError):
    """거래처 ID가 이미 사용중인 경우
    """
    _error: InitVar[InternalB2bCounterpartyIdAlreadyExistsError]

    def __post_init__(self, _error: InternalB2bCounterpartyIdAlreadyExistsError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyIdAlreadyExistsByPartnerError(CreateB2bCounterpartyError):
    """파트너 연동으로 생성된 거래처 ID가 이미 사용중인 경우

    파트너 연동으로 생성된 거래처 ID는 재사용할 수 없습니다.
    """
    _error: InitVar[InternalB2bCounterpartyIdAlreadyExistsByPartnerError]

    def __post_init__(self, _error: InternalB2bCounterpartyIdAlreadyExistsByPartnerError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyNtsConnectionFailedError(CreateB2bCounterpartyError):
    """국세청 연동에 실패한 경우
    """
    _error: InitVar[InternalB2bCounterpartyNtsConnectionFailedError]

    def __post_init__(self, _error: InternalB2bCounterpartyNtsConnectionFailedError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartyPartnerNotConnectableError(CreateB2bCounterpartyError):
    """파트너 연동 거래처는 국세청 연동이 허용되지 않는 경우

    파트너와 연동된 거래처는 국세청 연동을 직접 수행할 수 없습니다.
    """
    _error: InitVar[InternalB2bCounterpartyPartnerNotConnectableError]

    def __post_init__(self, _error: InternalB2bCounterpartyPartnerNotConnectableError) -> None:
        self.message = _error.message

@dataclass
class B2bCounterpartySelfOriginBrnMismatchError(CreateB2bCounterpartyError):
    """자사 사업자등록번호와 동일한 거래처를 생성할 수 없는 경우
    """
    _error: InitVar[InternalB2bCounterpartySelfOriginBrnMismatchError]

    def __post_init__(self, _error: InternalB2bCounterpartySelfOriginBrnMismatchError) -> None:
        self.message = _error.message
...
@dataclass
class PlatformPartnerNotFoundError(ArchivePlatformPartnerError, CancelPlatformPartnerScheduleError, ConnectBulkPartnerCounterpartyError, ConnectPartnerCounterpartyError, CreatePlatformManualTransferError, CreatePlatformOrderTransferError, DisconnectBulkPartnerCounterpartyError, DisconnectPartnerCounterpartyError, GetPlatformPartnerError, GetPlatformPartnerScheduleError, RecoverPlatformPartnerError, ReschedulePartnerError, SchedulePartnerError, UpdatePlatformPartnerError):
...
@dataclass
class PlatformArchivedPartnerError(ConnectPartnerCounterpartyError, SchedulePartnerError, UpdatePlatformPartnerError):
...
@dataclass
class PlatformExternalApiFailedError(ConnectBulkPartnerCounterpartyError, ConnectPartnerCounterpartyError, DisconnectBulkPartnerCounterpartyError, DisconnectPartnerCounterpartyError, GetPlatformAccountHolderError, GetPlatformCompanyStateError):
    """외부 api 오류
    """
...
@dataclass
class PlatformBulkPayoutIdAlreadyExistsError(CompletePlatformPayoutByPartnerSettlementIdsError):
    """일괄 지급 아이디가 이미 존재하는 경우
    """
    _error: InitVar[InternalPlatformBulkPayoutIdAlreadyExistsError]

    def __post_init__(self, _error: InternalPlatformBulkPayoutIdAlreadyExistsError) -> None:
        self.message = _error.message

@dataclass
class PlatformNegativePayoutAmountPartnersError(CompletePlatformPayoutByPartnerSettlementIdsError):
    """지급 금액의 총합이 음수인 파트너가 존재하는 경우
    """
    _error: InitVar[InternalPlatformNegativePayoutAmountPartnersError]

    def __post_init__(self, _error: InternalPlatformNegativePayoutAmountPartnersError) -> None:
        self.message = _error.message

@dataclass
class PlatformDuplicatedPartnerSettlementIdsError(CompletePlatformPayoutByPartnerSettlementIdsError):
    """선택된 정산건 아이디에 중복이 있는 경우
    """
    _error: InitVar[InternalPlatformDuplicatedPartnerSettlementIdsError]

    def __post_init__(self, _error: InternalPlatformDuplicatedPartnerSettlementIdsError) -> None:
        self.message = _error.message

@dataclass
class PlatformNonPayablePartnerSettlementsError(CompletePlatformPayoutByPartnerSettlementIdsError):
    """지급할 수 없는 정산건이 포함된 경우
    """
    ids: list[str] = field(init=False)
    graphql_ids: list[str] = field(init=False)
    _error: InitVar[InternalPlatformNonPayablePartnerSettlementsError]

    def __post_init__(self, _error: InternalPlatformNonPayablePartnerSettlementsError) -> None:
        self.ids = _error.ids
        self.graphql_ids = _error.graphql_ids
        self.message = _error.message

@dataclass
class PlatformNoSelectedPartnerSettlementsError(CompletePlatformPayoutByPartnerSettlementIdsError):
    """선택된 정산건이 없는 경우
    """
    _error: InitVar[InternalPlatformNoSelectedPartnerSettlementsError]

    def __post_init__(self, _error: InternalPlatformNoSelectedPartnerSettlementsError) -> None:
        self.message = _error.message

@dataclass
class PlatformPartnerSettlementsNotFoundError(CompletePlatformPayoutByPartnerSettlementIdsError, DeletePlatformPartnerSettlementsError):
    """요청한 정산건 목록을 찾을 수 없는 경우
    """
    ids: list[str] = field(init=False)
    graphql_ids: list[str] = field(init=False)
    _error: InitVar[InternalPlatformPartnerSettlementsNotFoundError]

    def __post_init__(self, _error: InternalPlatformPartnerSettlementsNotFoundError) -> None:
        self.ids = _error.ids
        self.graphql_ids = _error.graphql_ids
        self.message = _error.message

@dataclass
class PlatformNonDeletablePartnerSettlementsError(DeletePlatformPartnerSettlementsError):
    """삭제할 수 없는 정산건이 포함된 경우
    """
    ids: list[str] = field(init=False)
    graphql_ids: list[str] = field(init=False)
    _error: InitVar[InternalPlatformNonDeletablePartnerSettlementsError]

    def __post_init__(self, _error: InternalPlatformNonDeletablePartnerSettlementsError) -> None:
        self.ids = _error.ids
        self.graphql_ids = _error.graphql_ids
        self.message = _error.message

@dataclass
class PlatformReferencedCancelOrderTransfersExistError(DeletePlatformPartnerSettlementsError):
    """취소 정산건이 참조 중인 정산건이 포함된 경우
    """
    ids: list[str] = field(init=False)
    _error: InitVar[InternalPlatformReferencedCancelOrderTransfersExistError]

    def __post_init__(self, _error: InternalPlatformReferencedCancelOrderTransfersExistError) -> None:
        self.ids = _error.ids
        self.message = _error.message
...
@dataclass
class PlatformCurrencyNotSupportedError(CreatePlatformManualTransferError, CreatePlatformOrderTransferError, CreatePlatformPartnerError, CreatePlatformPartnersError):
    """지원 되지 않는 통화를 선택한 경우
    """
...
@dataclass
class PlatformArchivedPartnerNtsNotAllowedError(ConnectPartnerCounterpartyError, DisconnectPartnerCounterpartyError):
    """보관된 파트너는 국세청 연동/연동해제를 할 수 없는 경우
    """
    _error: InitVar[InternalPlatformArchivedPartnerNtsNotAllowedError]

    def __post_init__(self, _error: InternalPlatformArchivedPartnerNtsNotAllowedError) -> None:
        self.message = _error.message

@dataclass
class PlatformBtxNotEnabledError(ConnectBulkPartnerCounterpartyError, ConnectPartnerCounterpartyError, DisconnectBulkPartnerCounterpartyError, DisconnectPartnerCounterpartyError):
...
@dataclass
class PlatformCounterpartyNotConnectableStatusError(ConnectPartnerCounterpartyError):
    """파트너 거래처 연동 상태가 연동 가능한 상태가 아닌 경우
    """
    _error: InitVar[InternalPlatformCounterpartyNotConnectableStatusError]

    def __post_init__(self, _error: InternalPlatformCounterpartyNotConnectableStatusError) -> None:
        self.message = _error.message

@dataclass
class PlatformPartnerScheduleExistsError(ConnectPartnerCounterpartyError):
...
@dataclass
class PlatformPartnerTaxationTypeIsSimpleError(ConnectPartnerCounterpartyError, DisconnectPartnerCounterpartyError):
...
@dataclass
class PlatformPartnerTypeIsNotBusinessError(ConnectPartnerCounterpartyError, DisconnectPartnerCounterpartyError):
    """파트너 유형이 사업자가 아닌 경우
    """
...
@dataclass
class PlatformTargetPartnerNotFoundError(ConnectBulkPartnerCounterpartyError, DisconnectBulkPartnerCounterpartyError):
...
@dataclass
class PlatformCounterpartyNotConnectedError(DisconnectPartnerCounterpartyError):
    """파트너가 거래처로 연동 되어있지 않은 경우
    """
    _error: InitVar[InternalPlatformCounterpartyNotConnectedError]

    def __post_init__(self, _error: InternalPlatformCounterpartyNotConnectedError) -> None:
        self.message = _error.message

@dataclass
class PlatformOngoingTaxInvoiceExistsError(DisconnectPartnerCounterpartyError):
...
@dataclass
class PlatformCounterpartyOngoingTaxInvoiceExistsError(ArchivePlatformPartnerError):
    """연동된 거래처에 진행 중인 세금계산서가 있는 경우
    """
    _error: InitVar[InternalPlatformCounterpartyOngoingTaxInvoiceExistsError]

    def __post_init__(self, _error: InternalPlatformCounterpartyOngoingTaxInvoiceExistsError) -> None:
        self.message = _error.message

@dataclass
class PlatformPartnerPendingNtsOperationError(ArchivePlatformPartnerError, RecoverPlatformPartnerError):
    """파트너의 국세청 연동/해제가 진행 중인 경우
    """
    _error: InitVar[InternalPlatformPartnerPendingNtsOperationError]

    def __post_init__(self, _error: InternalPlatformPartnerPendingNtsOperationError) -> None:
        self.message = _error.message
...
@dataclass
class PlatformNegativeAmountNotAllowedError(CreatePlatformManualTransferError):
    """정산 건별 옵션이 켜진 플랫폼에서 음수 금액 수기 정산 생성을 시도한 경우
    """
    _error: InitVar[InternalPlatformNegativeAmountNotAllowedError]

    def __post_init__(self, _error: InternalPlatformNegativeAmountNotAllowedError) -> None:
        self.message = _error.message

@dataclass
class PlatformTransferIdAlreadyUsedError(CreatePlatformManualTransferError, CreatePlatformOrderCancelTransferError, CreatePlatformOrderTransferError):
    _error: InitVar[InternalPlatformTransferIdAlreadyUsedError]

    def __post_init__(self, _error: InternalPlatformTransferIdAlreadyUsedError) -> None:
        self.message = _error.message
...
@dataclass
class ChannelNotFoundError(GetPgCardPromotionsError, IssueBillingKeyError, IssueCashReceiptError, PayInstantlyError, PayWithBillingKeyError, SendIdentityVerificationError):
    """요청된 채널이 존재하지 않는 경우
    """
...
@dataclass
class MaxCancelCountReachedError(CancelPaymentError):
    """취소 시도 횟수가 초과된 경우
    """
    _error: InitVar[InternalMaxCancelCountReachedError]

    def __post_init__(self, _error: InternalMaxCancelCountReachedError) -> None:
        self.message = _error.message
...
@dataclass
class PaymentNotFoundError(ApplyEscrowLogisticsError, CancelPaymentError, CapturePaymentError, CloseVirtualAccountError, ConfirmEscrowError, ConfirmPaymentError, ConfirmPaymentwallDeliveryError, GetPaymentError, GetPaymentTransactionsError, ModifyEscrowLogisticsError, RegisterStoreReceiptError, ResendWebhookError, StopPaymentCancellationError):
    """결제 건이 존재하지 않는 경우
    """
...
@dataclass
class PaymentCancellationNotFoundError(StopPaymentCancellationError):
    """결제 취소 내역이 존재하지 않는 경우
    """
    _error: InitVar[InternalPaymentCancellationNotFoundError]

    def __post_init__(self, _error: InternalPaymentCancellationNotFoundError) -> None:
        self.message = _error.message

@dataclass
class PaymentCancellationNotPendingError(StopPaymentCancellationError):
    """결제 취소 내역이 취소 요청 상태가 아닌 경우
    """
    _error: InitVar[InternalPaymentCancellationNotPendingError]

    def __post_init__(self, _error: InternalPaymentCancellationNotPendingError) -> None:
        self.message = _error.message
...
@dataclass
class ProfileSettingsNotFoundError(EvaluateCheckoutProfileError):
    """프로필 설정이 존재하지 않는 경우
    """
    _error: InitVar[InternalProfileSettingsNotFoundError]

    def __post_init__(self, _error: InternalProfileSettingsNotFoundError) -> None:
        self.message = _error.message
...
@dataclass
class MaxTtlExceededError(CreatePaymentSessionError):
    """요청된 TTL이 정책 상한을 초과한 경우
    """
    _error: InitVar[InternalMaxTtlExceededError]

    def __post_init__(self, _error: InternalMaxTtlExceededError) -> None:
        self.message = _error.message

@dataclass
class SessionExpiredError(GetPaymentSessionError):
    """결제 세션이 만료된 경우
    """
    _error: InitVar[InternalSessionExpiredError]

    def __post_init__(self, _error: InternalSessionExpiredError) -> None:
        self.message = _error.message

@dataclass
class SessionNotFoundError(ClosePaymentSessionError, GetPaymentSessionError):
    """결제 세션이 존재하지 않는 경우
    """
    _error: InitVar[InternalSessionNotFoundError]

    def __post_init__(self, _error: InternalSessionNotFoundError) -> None:
        self.message = _error.message
@dataclass
class UnknownError(LoginViaApiSecretError, RefreshTokenError, CreateB2bCounterpartyError, DeleteB2bCounterpartyError, GetB2bCounterpartiesError, GetB2bCounterpartyCertificateError, GetB2bCounterpartyCertificateRegistrationUrlError, GetB2bCounterpartyError, UpdateB2bCounterpartyError, ValidateB2bCounterpartyCertificateError, AttachB2bTaxInvoiceFileError, CancelB2bTaxInvoiceIssuanceError, CancelB2bTaxInvoiceRequestError, CreateB2bFileUploadUrlError, DeleteB2bTaxInvoiceAttachmentError, DeleteB2bTaxInvoiceError, DownloadB2bTaxInvoicesSheetError, DraftB2bTaxInvoiceError, GetB2bBulkTaxInvoiceError, GetB2bTaxInvoiceAttachmentsError, GetB2bTaxInvoiceError, GetB2bTaxInvoicePdfDownloadUrlError, GetB2bTaxInvoicePopupUrlError, GetB2bTaxInvoicePrintUrlError, GetB2bTaxInvoicesError, IssueB2bTaxInvoiceError, IssueB2bTaxInvoiceImmediatelyError, RefuseB2bTaxInvoiceRequestError, RequestB2bTaxInvoiceReverseIssuanceError, SendToNtsB2bTaxInvoiceError, UpdateB2bTaxInvoiceDraftError, requestB2bTaxInvoiceError, EvaluateCheckoutProfileError, ConfirmIdentityVerificationError, GetIdentityVerificationError, GetIdentityVerificationsError, ResendIdentityVerificationError, SendIdentityVerificationError, GetPgCardPromotionsError, ConfirmBillingKeyError, ConfirmBillingKeyIssueAndPayError, DeleteBillingKeyError, GetBillingKeyInfoError, GetBillingKeyInfosError, IssueBillingKeyError, CancelCashReceiptError, GetCashReceiptError, GetCashReceiptsError, IssueCashReceiptError, ApplyEscrowLogisticsError, CancelPaymentError, CapturePaymentError, CloseVirtualAccountError, ConfirmEscrowError, ConfirmPaymentError, GetAllPaymentEventsError, GetAllPaymentsError, GetPaymentError, GetPaymentTransactionsError, GetPaymentsError, ModifyEscrowLogisticsError, PayInstantlyError, PayWithBillingKeyError, PreRegisterPaymentError, RegisterStoreReceiptError, ResendWebhookError, StopPaymentCancellationError, CreatePaymentScheduleError, GetPaymentScheduleError, GetPaymentSchedulesError, RevokePaymentSchedulesError, GetPromotionError, ClosePaymentSessionError, CreatePaymentSessionError, GetPaymentSessionError, ConfirmPaymentwallDeliveryError, GetKakaopayPaymentOrderError, GetPlatformAccountHolderError, GetPlatformAccountTransfersError, GetPlatformBulkAccountTransfersError, GetPlatformBulkPayoutsError, GetB2bBusinessInfosError, GetPlatformCompanyStateError, CancelPlatformAdditionalFeePolicyScheduleError, CancelPlatformContractScheduleError, CancelPlatformDiscountSharePolicyScheduleError, CancelPlatformPartnerScheduleError, GetPlatformAdditionalFeePolicyScheduleError, GetPlatformContractScheduleError, GetPlatformDiscountSharePolicyFilterOptionsError, GetPlatformDiscountSharePolicyScheduleError, GetPlatformPartnerFilterOptionsError, GetPlatformPartnerScheduleError, GetPlatformSettingError, RescheduleAdditionalFeePolicyError, RescheduleContractError, RescheduleDiscountSharePolicyError, ReschedulePartnerError, ScheduleAdditionalFeePolicyError, ScheduleContractError, ScheduleDiscountSharePolicyError, SchedulePartnerError, SchedulePlatformPartnersError, UpdatePlatformSettingError, ArchivePlatformPartnerError, ConnectBulkPartnerCounterpartyError, ConnectPartnerCounterpartyError, CreatePlatformPartnerError, CreatePlatformPartnersError, DisconnectBulkPartnerCounterpartyError, DisconnectPartnerCounterpartyError, GetPlatformPartnerError, GetPlatformPartnersError, RecoverPlatformPartnerError, UpdatePlatformPartnerError, DeletePlatformPartnerSettlementsError, GetPlatformPartnerSettlementsError, CompletePlatformPayoutByPartnerSettlementIdsError, GetPlatformPayoutsError, ArchivePlatformAdditionalFeePolicyError, ArchivePlatformContractError, ArchivePlatformDiscountSharePolicyError, CreatePlatformAdditionalFeePolicyError, CreatePlatformContractError, CreatePlatformDiscountSharePolicyError, GetPlatformAdditionalFeePoliciesError, GetPlatformAdditionalFeePolicyError, GetPlatformContractError, GetPlatformContractsError, GetPlatformDiscountSharePoliciesError, GetPlatformDiscountSharePolicyError, RecoverPlatformAdditionalFeePolicyError, RecoverPlatformContractError, RecoverPlatformDiscountSharePolicyError, UpdatePlatformAdditionalFeePolicyError, UpdatePlatformContractError, UpdatePlatformDiscountSharePolicyError, CreatePlatformManualTransferError, CreatePlatformOrderCancelTransferError, CreatePlatformOrderTransferError, DeletePlatformTransferError, DownloadPlatformTransferSheetError, GetPlatformTransferError, GetPlatformTransferSummariesError, GetPaymentReconciliationSettlementVatReportError, GetPaymentReconciliationTransactionVatReportError):
    """알 수 없는 경우"""
