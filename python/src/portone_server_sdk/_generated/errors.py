...
@dataclass
class PaymentNotFoundError(ApplyEscrowLogisticsError, CancelPaymentError, CapturePaymentError, CloseVirtualAccountError, ConfirmEscrowError, ConfirmPaymentError, GetPaymentError, GetPaymentTransactionsError, ModifyEscrowLogisticsError, RegisterStoreReceiptError, ResendWebhookError, StopPaymentCancellationError):
    """결제 건이 존재하지 않는 경우
    """
