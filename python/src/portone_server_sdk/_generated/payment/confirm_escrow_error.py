...
ConfirmEscrowError = Union[ForbiddenError, InvalidRequestError, PaymentNotFoundError, PaymentNotPaidError, PgProviderError, UnauthorizedError, dict]


def _serialize_confirm_escrow_error(obj: ConfirmEscrowError) -> Any:
...
def _deserialize_confirm_escrow_error(obj: Any) -> ConfirmEscrowError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ConfirmEscrowError")
