...
@dataclass
class PayPendingPaymentTransaction:
    """결제 완료 대기 상태 건
    """
    """결제 시도 상태
    """
...
def _serialize_pay_pending_payment_transaction(obj: PayPendingPaymentTransaction) -> Any:
...
def _deserialize_pay_pending_payment_transaction(obj: Any) -> PayPendingPaymentTransaction:
