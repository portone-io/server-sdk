...
from ..payment.instant_payment_method_input_virtual_account_option_fixed import InstantPaymentMethodInputVirtualAccountOptionFixed, _deserialize_instant_payment_method_input_virtual_account_option_fixed, _serialize_instant_payment_method_input_virtual_account_option_fixed
from ..payment.instant_payment_method_input_virtual_account_option_type import InstantPaymentMethodInputVirtualAccountOptionType, _deserialize_instant_payment_method_input_virtual_account_option_type, _serialize_instant_payment_method_input_virtual_account_option_type
...
class InstantPaymentMethodInputVirtualAccountOption:
    ...
    """발급 유형
    """
    fixed: Optional[InstantPaymentMethodInputVirtualAccountOptionFixed] = field(default=None)
    """고정식 가상계좌 발급 방식
