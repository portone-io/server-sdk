...
ModifyEscrowLogisticsError = Union[ForbiddenError, InvalidRequestError, PaymentNotFoundError, PaymentNotPaidError, PgProviderError, UnauthorizedError, dict]


def _serialize_modify_escrow_logistics_error(obj: ModifyEscrowLogisticsError) -> Any:
...
def _deserialize_modify_escrow_logistics_error(obj: Any) -> ModifyEscrowLogisticsError:
    try:
