...
@dataclass
class GetAllPaymentEventsByCursorBody:
...
def _serialize_get_all_payment_events_by_cursor_body(obj: GetAllPaymentEventsByCursorBody) -> Any:
...
def _deserialize_get_all_payment_events_by_cursor_body(obj: Any) -> GetAllPaymentEventsByCursorBody:
    ...
    if "size" in obj:
        ...
        size = None
    return GetAllPaymentEventsByCursorBody(store_id, from_, until, cursor, size)
