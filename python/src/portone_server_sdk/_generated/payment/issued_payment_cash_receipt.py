...
def _deserialize_issued_payment_cash_receipt(obj: Any) -> IssuedPaymentCashReceipt:
    ...
    if "url" in obj:
        ...
        url = None
    return IssuedPaymentCashReceipt(status, issue_number, total_amount, currency, issued_at, type, pg_receipt_id, tax_free_amount, url)
