...
def _deserialize_started_payment_schedule(obj: Any) -> StartedPaymentSchedule:
    ...
    if "products" in obj:
        ...
        products = None
    return StartedPaymentSchedule(id, merchant_id, store_id, payment_id, billing_key, order_name, is_cultural_expense, is_escrow, customer, custom_data, total_amount, currency, created_at, time_to_pay, started_at, tax_free_amount, vat_amount, installment_month, notice_urls, products)
