...
def _deserialize_succeeded_payment_schedule(obj: Any) -> SucceededPaymentSchedule:
    ...
    if "products" in obj:
        ...
        products = None
    return SucceededPaymentSchedule(id, merchant_id, store_id, payment_id, billing_key, order_name, is_cultural_expense, is_escrow, customer, custom_data, total_amount, currency, created_at, time_to_pay, started_at, completed_at, tax_free_amount, vat_amount, installment_month, notice_urls, products)
