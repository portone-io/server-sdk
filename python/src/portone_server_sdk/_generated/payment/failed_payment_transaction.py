...
@dataclass
class FailedPaymentTransaction:
    """결제 실패 상태 건
    """
    """결제 시도 상태
    """
...
def _serialize_failed_payment_transaction(obj: FailedPaymentTransaction) -> Any:
...
def _deserialize_failed_payment_transaction(obj: Any) -> FailedPaymentTransaction:
    ...
    failure = obj["failure"]
    failure = _deserialize_payment_failure(failure)
    if "method" in obj:
        method = obj["method"]
