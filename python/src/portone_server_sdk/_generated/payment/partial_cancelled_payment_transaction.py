...
@dataclass
class PartialCancelledPaymentTransaction:
    """결제 부분 취소 상태 건
    """
    """결제 시도 상태
    """
...
def _serialize_partial_cancelled_payment_transaction(obj: PartialCancelledPaymentTransaction) -> Any:
...
def _deserialize_partial_cancelled_payment_transaction(obj: Any) -> PartialCancelledPaymentTransaction:
