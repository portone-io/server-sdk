...
CapturePaymentError = Union[ForbiddenError, InvalidRequestError, PaymentNotFoundError, PaymentNotPaidError, PgProviderError, UnauthorizedError, dict]


def _serialize_capture_payment_error(obj: CapturePaymentError) -> Any:
...
def _deserialize_capture_payment_error(obj: Any) -> CapturePaymentError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not CapturePaymentError")
