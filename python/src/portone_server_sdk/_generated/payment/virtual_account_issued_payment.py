...
class VirtualAccountIssuedPayment:
    """가상계좌 발급 완료 상태 건
    """
    status: Literal["VIRTUAL_ACCOUNT_ISSUED"] = field(repr=False)
    """결제 건 상태
    """
    id: str
    """결제 건 아이디
