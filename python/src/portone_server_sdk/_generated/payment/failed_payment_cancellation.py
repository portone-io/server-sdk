...
def _deserialize_failed_payment_cancellation(obj: Any) -> FailedPaymentCancellation:
    ...
    if "cancelledAt" in obj:
        ...
        cancelled_at = None
    return FailedPaymentCancellation(status, id, total_amount, tax_free_amount, vat_amount, reason, requested_at, pg_cancellation_id, easy_pay_discount_amount, cancelled_at)
