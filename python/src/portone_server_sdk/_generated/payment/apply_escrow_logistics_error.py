...
ApplyEscrowLogisticsError = Union[ForbiddenError, InvalidRequestError, PaymentNotFoundError, PaymentNotPaidError, PgProviderError, UnauthorizedError]
...
def _deserialize_apply_escrow_logistics_error(obj: Any) -> ApplyEscrowLogisticsError:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ApplyEscrowLogisticsError")
