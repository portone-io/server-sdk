...
@dataclass
class CancelledPaymentTransaction:
    """결제 취소 상태 건
    """
    """결제 시도 상태
    """
...
def _serialize_cancelled_payment_transaction(obj: CancelledPaymentTransaction) -> Any:
...
def _deserialize_cancelled_payment_transaction(obj: Any) -> CancelledPaymentTransaction:
