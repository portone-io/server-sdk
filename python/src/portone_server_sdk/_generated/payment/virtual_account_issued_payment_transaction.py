...
@dataclass
class VirtualAccountIssuedPaymentTransaction:
    """가상계좌 발급 완료 상태 건
    """
    """결제 시도 상태
    """
...
def _serialize_virtual_account_issued_payment_transaction(obj: VirtualAccountIssuedPaymentTransaction) -> Any:
...
def _deserialize_virtual_account_issued_payment_transaction(obj: Any) -> VirtualAccountIssuedPaymentTransaction:
