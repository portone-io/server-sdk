...
def _deserialize_partial_cancelled_payment_event(obj: Any) -> PartialCancelledPaymentEvent:
    ...
    if "promotionId" in obj:
        ...
        promotion_id = None
    return PartialCancelledPaymentEvent(id, payment_id, transaction_id, merchant_id, store_id, channel, version, requested_at, created_at, order_name, total_amount, currency, customer, event_amount, method, channel_group, schedule_id, webhooks, is_cultural_expense, escrow, products, product_count, custom_data, country, pg_tx_id, cash_receipt, receipt_url, cancellation, promotion_id)
