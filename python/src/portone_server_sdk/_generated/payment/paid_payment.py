...
def _deserialize_paid_payment(obj: Any) -> PaidPayment:
    ...
    if "cancellations" in obj:
        ...
        cancellations = None
    return PaidPayment(id, transaction_id, merchant_id, store_id, channel, version, requested_at, updated_at, status_changed_at, order_name, amount, currency, customer, origin, paid_at, disputes, method, channel_group, schedule_id, billing_key, webhooks, promotion_id, is_cultural_expense, escrow, products, product_count, custom_data, country, pg_tx_id, pg_response, cash_receipt, cash_receipt_issuance_status, receipt_url, cancellations)
