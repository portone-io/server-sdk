...
class PaidPayment:
    """결제 완료 상태 건
    """
    status: Literal["PAID"] = field(repr=False)
    """결제 건 상태
    """
    id: str
    """결제 건 아이디
