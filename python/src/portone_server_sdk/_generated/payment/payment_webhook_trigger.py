...
PaymentWebhookTrigger = Union[Literal["MANUAL", "VIRTUAL_ACCOUNT_DEPOSIT", "ASYNC_CANCEL_APPROVED", "ASYNC_CANCEL_FAILED", "ASYNC_PAY_APPROVED", "ASYNC_PAY_FAILED", "DISPUTE_CREATED", "DISPUTE_RESOLVED"], str]
"""웹훅 실행 트리거
