...
def _deserialize_register_escrow_logistics_body(obj: Any) -> RegisterEscrowLogisticsBody:
    ...
    if "products" in obj:
        ...
        products = None
    return RegisterEscrowLogisticsBody(logistics, store_id, sender, receiver, send_email, products)
