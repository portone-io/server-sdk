...
def _deserialize_issued_billing_key_info(obj: Any) -> IssuedBillingKeyInfo:
    ...
    return IssuedBillingKeyInfo(billing_key, merchant_id, store_id, channels, customer, issued_at, methods, custom_data, issue_id, issue_name, requested_at, channel_group, pg_billing_key_issue_responses)
