...
ConfirmBillingKeyIssueAndPayError = Union[BillingKeyAlreadyIssuedError, BillingKeyNotFoundError, ForbiddenError, InformationMismatchError, InvalidRequestError, PgProviderError, UnauthorizedError, dict]


def _serialize_confirm_billing_key_issue_and_pay_error(obj: ConfirmBillingKeyIssueAndPayError) -> Any:
...
def _deserialize_confirm_billing_key_issue_and_pay_error(obj: Any) -> ConfirmBillingKeyIssueAndPayError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ConfirmBillingKeyIssueAndPayError")
