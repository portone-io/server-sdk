...
@dataclass
class GetPaymentReconciliationSettlementVatReportResponse:
...
def _serialize_get_payment_reconciliation_settlement_vat_report_response(obj: GetPaymentReconciliationSettlementVatReportResponse) -> Any:
...
def _deserialize_get_payment_reconciliation_settlement_vat_report_response(obj: Any) -> GetPaymentReconciliationSettlementVatReportResponse:
    ...
    if "pgSpecifiers" in obj:
        ...
        pg_specifiers = None
    return GetPaymentReconciliationSettlementVatReportResponse(summary, items, pg_specifiers)
