...
@dataclass
class ReschedulePlatformDiscountSharePolicyBody:
...
def _serialize_reschedule_platform_discount_share_policy_body(obj: ReschedulePlatformDiscountSharePolicyBody) -> Any:
    entity = {}
...
def _deserialize_reschedule_platform_discount_share_policy_body(obj: Any) -> ReschedulePlatformDiscountSharePolicyBody:
    ...
    return ReschedulePlatformDiscountSharePolicyBody(update, applied_at)
