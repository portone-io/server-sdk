...
UpdatePlatformContractError = Union[ForbiddenError, InvalidRequestError, PlatformArchivedContractError, PlatformContractNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_update_platform_contract_error(obj: UpdatePlatformContractError) -> Any:
...
def _deserialize_update_platform_contract_error(obj: Any) -> UpdatePlatformContractError:
    try:
