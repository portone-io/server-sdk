...
UpdatePlatformContractError = Union[ForbiddenError, InvalidRequestError, PlatformArchivedContractError, PlatformContractNotFoundError, PlatformNotEnabledError, UnauthorizedError]
