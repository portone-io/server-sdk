...
GetPlatformDiscountSharePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformDiscountSharePolicyNotFoundError, PlatformNotEnabledError, UnauthorizedError]
...
def _deserialize_get_platform_discount_share_policy_error(obj: Any) -> GetPlatformDiscountSharePolicyError:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetPlatformDiscountSharePolicyError")
