...
RecoverPlatformContractError = Union[ForbiddenError, InvalidRequestError, PlatformContractNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_recover_platform_contract_error(obj: RecoverPlatformContractError) -> Any:
...
def _deserialize_recover_platform_contract_error(obj: Any) -> RecoverPlatformContractError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not RecoverPlatformContractError")
