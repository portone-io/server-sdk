...
from portone_server_sdk._generated.platform.policy.platform_discount_share_policy_filter_input_keyword import PlatformDiscountSharePolicyFilterInputKeyword, _deserialize_platform_discount_share_policy_filter_input_keyword, _serialize_platform_discount_share_policy_filter_input_keyword
...
class PlatformDiscountSharePolicyFilterInput:
    ...
    """
    partner_share_rates: Optional[list[int]]
    """하나 이상의 값이 존재하는 경우 해당 리스트에 포함되는 파트너 분담율을 가진 할인 분담 정책만 조회합니다.
    """
    keyword: Optional[PlatformDiscountSharePolicyFilterInputKeyword]
    """검색 키워드
    """
