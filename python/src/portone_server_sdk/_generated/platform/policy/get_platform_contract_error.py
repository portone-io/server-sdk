...
GetPlatformContractError = Union[ForbiddenError, InvalidRequestError, PlatformContractNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_get_platform_contract_error(obj: GetPlatformContractError) -> Any:
...
def _deserialize_get_platform_contract_error(obj: Any) -> GetPlatformContractError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetPlatformContractError")
