...
RecoverPlatformAdditionalFeePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformAdditionalFeePolicyNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_recover_platform_additional_fee_policy_error(obj: RecoverPlatformAdditionalFeePolicyError) -> Any:
...
def _deserialize_recover_platform_additional_fee_policy_error(obj: Any) -> RecoverPlatformAdditionalFeePolicyError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not RecoverPlatformAdditionalFeePolicyError")
