...
GetPlatformAdditionalFeePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformAdditionalFeePolicyNotFoundError, PlatformNotEnabledError, UnauthorizedError]
...
def _deserialize_get_platform_additional_fee_policy_error(obj: Any) -> GetPlatformAdditionalFeePolicyError:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetPlatformAdditionalFeePolicyError")
