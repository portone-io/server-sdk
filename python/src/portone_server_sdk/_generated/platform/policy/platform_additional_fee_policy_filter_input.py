...
from portone_server_sdk._generated.platform.policy.platform_additional_fee_policy_filter_input_keyword import PlatformAdditionalFeePolicyFilterInputKeyword, _deserialize_platform_additional_fee_policy_filter_input_keyword, _serialize_platform_additional_fee_policy_filter_input_keyword
...
class PlatformAdditionalFeePolicyFilterInput:
    ...
    """
    vat_payers: Optional[list[PlatformPayer]]
    """금액 부담 주체

    하나 이상의 값이 존재하는 경우 해당 리스트에 포함되는 부가세 부담 주체에 해당하는 추가 수수료 정책만 조회합니다.
    """
    keyword: Optional[PlatformAdditionalFeePolicyFilterInputKeyword]
    """검색 키워드
    """
