...
from ...platform.policy.platform_cannot_archive_scheduled_additional_fee_policy_error import PlatformCannotArchiveScheduledAdditionalFeePolicyError, _deserialize_platform_cannot_archive_scheduled_additional_fee_policy_error, _serialize_platform_cannot_archive_scheduled_additional_fee_policy_error
...
ArchivePlatformAdditionalFeePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformAdditionalFeePolicyNotFoundError, PlatformCannotArchiveScheduledAdditionalFeePolicyError, PlatformNotEnabledError, UnauthorizedError, dict]
...
def _serialize_archive_platform_additional_fee_policy_error(obj: ArchivePlatformAdditionalFeePolicyError) -> Any:
    ...
    if isinstance(obj, PlatformCannotArchiveScheduledAdditionalFeePolicyError):
