...
UpdatePlatformDiscountSharePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformArchivedDiscountSharePolicyError, PlatformDiscountSharePolicyNotFoundError, PlatformNotEnabledError, UnauthorizedError]


def _serialize_update_platform_discount_share_policy_error(obj: UpdatePlatformDiscountSharePolicyError) -> Any:
...
def _deserialize_update_platform_discount_share_policy_error(obj: Any) -> UpdatePlatformDiscountSharePolicyError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not UpdatePlatformDiscountSharePolicyError")
