...
ReschedulePartnerError = Union[ForbiddenError, InvalidRequestError, PlatformContractNotFoundError, PlatformNotEnabledError, PlatformPartnerNotFoundError, UnauthorizedError, dict]
