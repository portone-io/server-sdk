...
from portone_server_sdk._generated.platform.transfer.create_platform_order_cancel_transfer_body_order_detail_all import CreatePlatformOrderCancelTransferBodyOrderDetailAll, _deserialize_create_platform_order_cancel_transfer_body_order_detail_all, _serialize_create_platform_order_cancel_transfer_body_order_detail_all
from portone_server_sdk._generated.platform.transfer.create_platform_order_cancel_transfer_body_order_line import CreatePlatformOrderCancelTransferBodyOrderLine, _deserialize_create_platform_order_cancel_transfer_body_order_line, _serialize_create_platform_order_cancel_transfer_body_order_line
...
class CreatePlatformOrderCancelTransferBodyOrderDetail:
    ...
    (int64)
    """
    order_lines: Optional[list[CreatePlatformOrderCancelTransferBodyOrderLine]]
    """주문 취소 항목 리스트
    """
    all: Optional[CreatePlatformOrderCancelTransferBodyOrderDetailAll]
    """전체 금액 취소
    """
