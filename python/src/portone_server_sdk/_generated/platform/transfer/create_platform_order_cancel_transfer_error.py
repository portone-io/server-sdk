...
from ...platform.transfer.platform_settlement_date_earlier_than_settlement_start_date_error import PlatformSettlementDateEarlierThanSettlementStartDateError, _deserialize_platform_settlement_date_earlier_than_settlement_start_date_error, _serialize_platform_settlement_date_earlier_than_settlement_start_date_error
...
CreatePlatformOrderCancelTransferError = Union[ForbiddenError, InvalidRequestError, PlatformCancellableAmountExceededError, PlatformCancellableDiscountAmountExceededError, PlatformCancellableDiscountTaxFreeAmountExceededError, PlatformCancellableProductQuantityExceededError, PlatformCancellationAndPaymentTypeMismatchedError, PlatformCancellationNotFoundError, PlatformCannotSpecifyTransferError, PlatformDiscountSharePolicyIdDuplicatedError, PlatformNotEnabledError, PlatformOrderDetailMismatchedError, PlatformOrderTransferAlreadyCancelledError, PlatformPaymentNotFoundError, PlatformProductIdDuplicatedError, PlatformProductIdNotFoundError, PlatformSettlementAmountExceededError, PlatformSettlementCancelAmountExceededPortOneCancelError, PlatformSettlementDateEarlierThanSettlementStartDateError, PlatformTransferAlreadyExistsError, PlatformTransferDiscountSharePolicyNotFoundError, PlatformTransferNotFoundError, PlatformUserDefinedPropertyNotFoundError, UnauthorizedError, dict]
...
def _serialize_create_platform_order_cancel_transfer_error(obj: CreatePlatformOrderCancelTransferError) -> Any:
    ...
    if isinstance(obj, PlatformSettlementDateEarlierThanSettlementStartDateError):
        return _serialize_platform_settlement_date_earlier_than_settlement_start_date_error(obj)
...
def _deserialize_create_platform_order_cancel_transfer_error(obj: Any) -> CreatePlatformOrderCancelTransferError:
    ...
    try:
        ...
        pass
    try:
        return _deserialize_platform_settlement_date_earlier_than_settlement_start_date_error(obj)
    except Exception:
        pass
    try:
