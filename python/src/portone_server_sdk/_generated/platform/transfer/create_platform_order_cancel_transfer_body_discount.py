...
@dataclass
class CreatePlatformOrderCancelTransferBodyDiscount:
    """할인 정보
    """
    share_policy_id: str
    """할인 분담 정책 아이디
...
def _serialize_create_platform_order_cancel_transfer_body_discount(obj: CreatePlatformOrderCancelTransferBodyDiscount) -> Any:
...
def _deserialize_create_platform_order_cancel_transfer_body_discount(obj: Any) -> CreatePlatformOrderCancelTransferBodyDiscount:
    ...
    return CreatePlatformOrderCancelTransferBodyDiscount(share_policy_id, amount, tax_free_amount)
