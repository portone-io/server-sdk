...
def _deserialize_update_platform_partner_body_account(obj: Any) -> UpdatePlatformPartnerBodyAccount:
    ...
    return UpdatePlatformPartnerBodyAccount(bank, currency, number, holder, account_verification_id)
