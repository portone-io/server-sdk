...
CancelPlatformContractScheduleError = Union[ForbiddenError, InvalidRequestError, PlatformContractNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_cancel_platform_contract_schedule_error(obj: CancelPlatformContractScheduleError) -> Any:
...
def _deserialize_cancel_platform_contract_schedule_error(obj: Any) -> CancelPlatformContractScheduleError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not CancelPlatformContractScheduleError")
