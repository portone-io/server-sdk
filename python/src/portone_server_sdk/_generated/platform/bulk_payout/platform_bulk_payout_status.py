...
PlatformBulkPayoutStatus = Literal["PREPARING", "PREPARED", "ONGOING", "CANCELLED", "STOPPED", "COMPLETED"]
...
def _deserialize_platform_bulk_payout_status(obj: Any) -> PlatformBulkPayoutStatus:
    if obj not in ["PREPARING", "PREPARED", "ONGOING", "CANCELLED", "STOPPED", "COMPLETED"]:
