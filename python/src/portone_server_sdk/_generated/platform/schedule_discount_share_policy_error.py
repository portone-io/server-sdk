...
ScheduleDiscountSharePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformDiscountSharePolicyNotFoundError, PlatformDiscountSharePolicyScheduleAlreadyExistsError, PlatformNotEnabledError, UnauthorizedError]
