...
from ...platform.partner.platform_archived_partner_nts_not_allowed_error import PlatformArchivedPartnerNtsNotAllowedError, _deserialize_platform_archived_partner_nts_not_allowed_error, _serialize_platform_archived_partner_nts_not_allowed_error
...
from ...platform.partner.platform_counterparty_not_connectable_status_error import PlatformCounterpartyNotConnectableStatusError, _deserialize_platform_counterparty_not_connectable_status_error, _serialize_platform_counterparty_not_connectable_status_error
...
ConnectPartnerCounterpartyError = Union[ForbiddenError, InvalidRequestError, PlatformArchivedPartnerError, PlatformArchivedPartnerNtsNotAllowedError, PlatformBtxNotEnabledError, PlatformCounterpartyNotConnectableStatusError, PlatformExternalApiFailedError, PlatformNotEnabledError, PlatformPartnerNotFoundError, PlatformPartnerScheduleExistsError, PlatformPartnerTaxationTypeIsSimpleError, PlatformPartnerTypeIsNotBusinessError, UnauthorizedError, dict]


def _serialize_connect_partner_counterparty_error(obj: ConnectPartnerCounterpartyError) -> Any:
    ...
    if isinstance(obj, PlatformArchivedPartnerNtsNotAllowedError):
        return _serialize_platform_archived_partner_nts_not_allowed_error(obj)
    if isinstance(obj, PlatformBtxNotEnabledError):
        return _serialize_platform_btx_not_enabled_error(obj)
    if isinstance(obj, PlatformCounterpartyNotConnectableStatusError):
        return _serialize_platform_counterparty_not_connectable_status_error(obj)
...
def _deserialize_connect_partner_counterparty_error(obj: Any) -> ConnectPartnerCounterpartyError:
    try:
    ...
    try:
        ...
        pass
    try:
        return _deserialize_platform_archived_partner_nts_not_allowed_error(obj)
    except Exception:
        pass
    try:
        ...
        pass
    try:
        return _deserialize_platform_counterparty_not_connectable_status_error(obj)
    except Exception:
        pass
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ConnectPartnerCounterpartyError")
