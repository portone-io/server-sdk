...
DisconnectBulkPartnerCounterpartyError = Union[ForbiddenError, InvalidRequestError, PlatformBtxNotEnabledError, PlatformExternalApiFailedError, PlatformNotEnabledError, PlatformPartnerNotFoundError, PlatformTargetPartnerNotFoundError, UnauthorizedError, dict]


def _serialize_disconnect_bulk_partner_counterparty_error(obj: DisconnectBulkPartnerCounterpartyError) -> Any:
...
def _deserialize_disconnect_bulk_partner_counterparty_error(obj: Any) -> DisconnectBulkPartnerCounterpartyError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not DisconnectBulkPartnerCounterpartyError")
