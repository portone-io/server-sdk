...
from ...platform.partner.platform_counterparty_not_connected_error import PlatformCounterpartyNotConnectedError, _deserialize_platform_counterparty_not_connected_error, _serialize_platform_counterparty_not_connected_error
...
DisconnectPartnerCounterpartyError = Union[ForbiddenError, InvalidRequestError, PlatformArchivedPartnerNtsNotAllowedError, PlatformBtxNotEnabledError, PlatformCounterpartyNotConnectedError, PlatformExternalApiFailedError, PlatformNotEnabledError, PlatformOngoingTaxInvoiceExistsError, PlatformPartnerNotFoundError, PlatformPartnerTaxationTypeIsSimpleError, PlatformPartnerTypeIsNotBusinessError, UnauthorizedError, dict]


def _serialize_disconnect_partner_counterparty_error(obj: DisconnectPartnerCounterpartyError) -> Any:
    ...
    if isinstance(obj, PlatformCounterpartyNotConnectedError):
        return _serialize_platform_counterparty_not_connected_error(obj)
...
def _deserialize_disconnect_partner_counterparty_error(obj: Any) -> DisconnectPartnerCounterpartyError:
    try:
    ...
    try:
        ...
        pass
    try:
        return _deserialize_platform_counterparty_not_connected_error(obj)
    except Exception:
        pass
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not DisconnectPartnerCounterpartyError")
