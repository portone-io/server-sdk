...
@dataclass
class DisconnectBulkPartnerCounterpartyResponse:
    """파트너 일괄 거래처 연동 해제 응답
    """
    bulk_task: PlatformBulkTask


def _serialize_disconnect_bulk_partner_counterparty_response(obj: DisconnectBulkPartnerCounterpartyResponse) -> Any:
...
def _deserialize_disconnect_bulk_partner_counterparty_response(obj: Any) -> DisconnectBulkPartnerCounterpartyResponse:
    ...
    return DisconnectBulkPartnerCounterpartyResponse(bulk_task)
