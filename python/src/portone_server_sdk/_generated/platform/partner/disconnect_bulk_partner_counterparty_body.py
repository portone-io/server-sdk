...
@dataclass
class DisconnectBulkPartnerCounterpartyBody:
...
def _serialize_disconnect_bulk_partner_counterparty_body(obj: DisconnectBulkPartnerCounterpartyBody) -> Any:
...
def _deserialize_disconnect_bulk_partner_counterparty_body(obj: Any) -> DisconnectBulkPartnerCounterpartyBody:
    ...
    if "filter" in obj:
        ...
        filter = None
    return DisconnectBulkPartnerCounterpartyBody(filter)
