...
DisconnectBulkPartnerMemberCompanyError = Union[ForbiddenError, InvalidRequestError, PlatformBtxNotEnabledError, PlatformExternalApiFailedError, PlatformNotEnabledError, PlatformPartnerNotFoundError, PlatformTargetPartnerNotFoundError, UnauthorizedError, dict]


def _serialize_disconnect_bulk_partner_member_company_error(obj: DisconnectBulkPartnerMemberCompanyError) -> Any:
...
def _deserialize_disconnect_bulk_partner_member_company_error(obj: Any) -> DisconnectBulkPartnerMemberCompanyError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not DisconnectBulkPartnerMemberCompanyError")
