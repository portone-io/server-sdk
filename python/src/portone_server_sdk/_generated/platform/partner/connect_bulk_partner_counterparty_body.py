...
@dataclass
class ConnectBulkPartnerCounterpartyBody:
    """파트너 일괄 거래처 연동 요청 정보
...
def _serialize_connect_bulk_partner_counterparty_body(obj: ConnectBulkPartnerCounterpartyBody) -> Any:
...
def _deserialize_connect_bulk_partner_counterparty_body(obj: Any) -> ConnectBulkPartnerCounterpartyBody:
    ...
    if "filter" in obj:
        ...
        filter = None
    return ConnectBulkPartnerCounterpartyBody(filter)
