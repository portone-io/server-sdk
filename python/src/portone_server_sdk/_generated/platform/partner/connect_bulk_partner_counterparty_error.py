...
ConnectBulkPartnerCounterpartyError = Union[ForbiddenError, InvalidRequestError, PlatformBtxNotEnabledError, PlatformExternalApiFailedError, PlatformNotEnabledError, PlatformPartnerNotFoundError, PlatformTargetPartnerNotFoundError, UnauthorizedError, dict]


def _serialize_connect_bulk_partner_counterparty_error(obj: ConnectBulkPartnerCounterpartyError) -> Any:
...
def _deserialize_connect_bulk_partner_counterparty_error(obj: Any) -> ConnectBulkPartnerCounterpartyError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ConnectBulkPartnerCounterpartyError")
