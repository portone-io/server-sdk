...
GetPlatformPartnerError = Union[ForbiddenError, InvalidRequestError, PlatformNotEnabledError, PlatformPartnerNotFoundError, UnauthorizedError, dict]


def _serialize_get_platform_partner_error(obj: GetPlatformPartnerError) -> Any:
...
def _deserialize_get_platform_partner_error(obj: Any) -> GetPlatformPartnerError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetPlatformPartnerError")
