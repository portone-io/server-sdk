...
@dataclass
class ReschedulePlatformContractBody:
...
def _deserialize_reschedule_platform_contract_body(obj: Any) -> ReschedulePlatformContractBody:
    ...
    return ReschedulePlatformContractBody(update, applied_at)
