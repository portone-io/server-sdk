...
class UpdatePlatformBody:
    ...
    """
    round_type: Optional[PlatformRoundType]
    """파트너 정산금액의 소수점 처리 방식
    """
    settlement_formula: Optional[UpdatePlatformBodySettlementFormula]
    """수수료 및 할인 분담 정책 관련 계산식
    """
    settlement_rule: Optional[UpdatePlatformBodySettlementRule]
    """정산 규칙
    """
