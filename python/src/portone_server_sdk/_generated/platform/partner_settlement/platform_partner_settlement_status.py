...
PlatformPartnerSettlementStatus = Literal["PAYOUT_PREPARED", "PAYOUT_WITHHELD", "PAYOUT_FAILED", "IN_PAYOUT", "PAID_OUT"]
"""정산 상태
"""
...
def _deserialize_platform_partner_settlement_status(obj: Any) -> PlatformPartnerSettlementStatus:
    if obj not in ["PAYOUT_PREPARED", "PAYOUT_WITHHELD", "PAYOUT_FAILED", "IN_PAYOUT", "PAID_OUT"]:
