...
PlatformPartnerSettlementStatus = Union[Literal["PAYOUT_SCHEDULED", "PAYOUT_PREPARED", "PAYOUT_WITHHELD", "PAYOUT_EXCLUDED", "PAYOUT_FAILED", "IN_PAYOUT", "PAID_OUT", "CANCELLED", "CONFIRMED"], str]
"""정산 상태
"""
