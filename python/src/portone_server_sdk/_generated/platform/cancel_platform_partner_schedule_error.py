...
CancelPlatformPartnerScheduleError = Union[ForbiddenError, InvalidRequestError, PlatformNotEnabledError, PlatformPartnerNotFoundError, UnauthorizedError, dict]


def _serialize_cancel_platform_partner_schedule_error(obj: CancelPlatformPartnerScheduleError) -> Any:
...
def _deserialize_cancel_platform_partner_schedule_error(obj: Any) -> CancelPlatformPartnerScheduleError:
    try:
