...
from ..platform.platform_additional_fee_policy_schedule_already_exists_error import PlatformAdditionalFeePolicyScheduleAlreadyExistsError, _deserialize_platform_additional_fee_policy_schedule_already_exists_error, _serialize_platform_additional_fee_policy_schedule_already_exists_error
...
ScheduleAdditionalFeePolicyError = Union[ForbiddenError, InvalidRequestError, PlatformAdditionalFeePolicyNotFoundError, PlatformAdditionalFeePolicyScheduleAlreadyExistsError, PlatformArchivedAdditionalFeePolicyError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_schedule_additional_fee_policy_error(obj: ScheduleAdditionalFeePolicyError) -> Any:
    ...
    if isinstance(obj, PlatformAdditionalFeePolicyScheduleAlreadyExistsError):
        return _serialize_platform_additional_fee_policy_schedule_already_exists_error(obj)
...
def _deserialize_schedule_additional_fee_policy_error(obj: Any) -> ScheduleAdditionalFeePolicyError:
    try:
    ...
    try:
        ...
        pass
    try:
        return _deserialize_platform_additional_fee_policy_schedule_already_exists_error(obj)
    except Exception:
        pass
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not ScheduleAdditionalFeePolicyError")
