...
GetPlatformPartnerFilterOptionsError = Union[ForbiddenError, InvalidRequestError, PlatformNotEnabledError, UnauthorizedError]
...
def _deserialize_get_platform_partner_filter_options_error(obj: Any) -> GetPlatformPartnerFilterOptionsError:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetPlatformPartnerFilterOptionsError")
