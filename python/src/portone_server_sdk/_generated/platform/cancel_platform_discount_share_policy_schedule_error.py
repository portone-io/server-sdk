...
CancelPlatformDiscountSharePolicyScheduleError = Union[ForbiddenError, InvalidRequestError, PlatformDiscountSharePolicyNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_cancel_platform_discount_share_policy_schedule_error(obj: CancelPlatformDiscountSharePolicyScheduleError) -> Any:
...
def _deserialize_cancel_platform_discount_share_policy_schedule_error(obj: Any) -> CancelPlatformDiscountSharePolicyScheduleError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not CancelPlatformDiscountSharePolicyScheduleError")
