...
GetPlatformPartnerScheduleError = Union[ForbiddenError, InvalidRequestError, PlatformNotEnabledError, PlatformPartnerNotFoundError, UnauthorizedError, dict]


def _serialize_get_platform_partner_schedule_error(obj: GetPlatformPartnerScheduleError) -> Any:
...
def _deserialize_get_platform_partner_schedule_error(obj: Any) -> GetPlatformPartnerScheduleError:
    try:
    ...
    try:
        ...
        pass
    raise ValueError(f"{repr(obj)} is not GetPlatformPartnerScheduleError")
