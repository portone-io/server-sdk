...
GetPlatformContractScheduleError = Union[ForbiddenError, InvalidRequestError, PlatformContractNotFoundError, PlatformNotEnabledError, UnauthorizedError, dict]


def _serialize_get_platform_contract_schedule_error(obj: GetPlatformContractScheduleError) -> Any:
...
def _deserialize_get_platform_contract_schedule_error(obj: Any) -> GetPlatformContractScheduleError:
    try:
