...
def _serialize_analytics_card_chart_stat(obj: AnalyticsCardChartStat) -> Any:
    entity = {}
...
def _deserialize_analytics_card_chart_stat(obj: Any) -> AnalyticsCardChartStat:
    ...
    return AnalyticsCardChartStat(timestamp, amount, count)
