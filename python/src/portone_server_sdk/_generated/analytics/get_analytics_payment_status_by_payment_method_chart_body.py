...
@dataclass
class GetAnalyticsPaymentStatusByPaymentMethodChartBody:
...
def _serialize_get_analytics_payment_status_by_payment_method_chart_body(obj: GetAnalyticsPaymentStatusByPaymentMethodChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_payment_status_by_payment_method_chart_body(obj: Any) -> GetAnalyticsPaymentStatusByPaymentMethodChartBody:
    ...
    return GetAnalyticsPaymentStatusByPaymentMethodChartBody(from_, until, currency)
