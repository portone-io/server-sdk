...
@dataclass
class GetAnalyticsPaymentStatusChartBody:
...
def _serialize_get_analytics_payment_status_chart_body(obj: GetAnalyticsPaymentStatusChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_payment_status_chart_body(obj: Any) -> GetAnalyticsPaymentStatusChartBody:
    ...
    return GetAnalyticsPaymentStatusChartBody(from_, until, currency)
