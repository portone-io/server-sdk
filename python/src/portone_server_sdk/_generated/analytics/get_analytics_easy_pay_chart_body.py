...
@dataclass
class GetAnalyticsEasyPayChartBody:
...
def _serialize_get_analytics_easy_pay_chart_body(obj: GetAnalyticsEasyPayChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_easy_pay_chart_body(obj: Any) -> GetAnalyticsEasyPayChartBody:
    ...
    return GetAnalyticsEasyPayChartBody(from_, until, currency, exclude_cancelled, time_granularity)
