...
@dataclass
class AnalyticsPaymentChartStat:
...
def _serialize_analytics_payment_chart_stat(obj: AnalyticsPaymentChartStat) -> Any:
    entity = {}
...
def _deserialize_analytics_payment_chart_stat(obj: Any) -> AnalyticsPaymentChartStat:
    ...
    return AnalyticsPaymentChartStat(timestamp, amount, count)
