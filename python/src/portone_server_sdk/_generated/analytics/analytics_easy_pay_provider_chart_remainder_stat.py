...
@dataclass
class AnalyticsEasyPayProviderChartRemainderStat:
...
def _serialize_analytics_easy_pay_provider_chart_remainder_stat(obj: AnalyticsEasyPayProviderChartRemainderStat) -> Any:
    entity = {}
...
def _deserialize_analytics_easy_pay_provider_chart_remainder_stat(obj: Any) -> AnalyticsEasyPayProviderChartRemainderStat:
    ...
    return AnalyticsEasyPayProviderChartRemainderStat(timestamp, amount, count)
