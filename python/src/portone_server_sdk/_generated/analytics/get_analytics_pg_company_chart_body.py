...
@dataclass
class GetAnalyticsPgCompanyChartBody:
...
def _serialize_get_analytics_pg_company_chart_body(obj: GetAnalyticsPgCompanyChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_pg_company_chart_body(obj: Any) -> GetAnalyticsPgCompanyChartBody:
    ...
    return GetAnalyticsPgCompanyChartBody(from_, until, currency, exclude_cancelled)
