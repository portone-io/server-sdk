...
@dataclass
class GetAnalyticsPaymentMethodTrendChartBody:
...
def _serialize_get_analytics_payment_method_trend_chart_body(obj: GetAnalyticsPaymentMethodTrendChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_payment_method_trend_chart_body(obj: Any) -> GetAnalyticsPaymentMethodTrendChartBody:
    ...
    return GetAnalyticsPaymentMethodTrendChartBody(from_, until, currency, exclude_cancelled, time_granularity)
