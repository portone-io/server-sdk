...
@dataclass
class GetAnalyticsPaymentChartBody:
...
def _serialize_get_analytics_payment_chart_body(obj: GetAnalyticsPaymentChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_payment_chart_body(obj: Any) -> GetAnalyticsPaymentChartBody:
    ...
    return GetAnalyticsPaymentChartBody(from_, until, currency, time_granularity, exclude_cancelled)
