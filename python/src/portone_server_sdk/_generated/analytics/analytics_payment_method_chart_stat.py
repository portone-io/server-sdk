...
@dataclass
class AnalyticsPaymentMethodChartStat:
...
def _serialize_analytics_payment_method_chart_stat(obj: AnalyticsPaymentMethodChartStat) -> Any:
    entity = {}
...
def _deserialize_analytics_payment_method_chart_stat(obj: Any) -> AnalyticsPaymentMethodChartStat:
    ...
    if "paymentMethod" in obj:
        ...
        payment_method = None
    return AnalyticsPaymentMethodChartStat(amount, count, payment_method)
