...
@dataclass
class GetAnalyticsCardChartBody:
...
def _serialize_get_analytics_card_chart_body(obj: GetAnalyticsCardChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_card_chart_body(obj: Any) -> GetAnalyticsCardChartBody:
    ...
    return GetAnalyticsCardChartBody(from_, until, currency, exclude_cancelled, time_granularity)
