...
@dataclass
class GetAnalyticsPaymentStatusByPaymentClientChartBody:
...
def _serialize_get_analytics_payment_status_by_payment_client_chart_body(obj: GetAnalyticsPaymentStatusByPaymentClientChartBody) -> Any:
    entity = {}
...
def _deserialize_get_analytics_payment_status_by_payment_client_chart_body(obj: Any) -> GetAnalyticsPaymentStatusByPaymentClientChartBody:
    ...
    return GetAnalyticsPaymentStatusByPaymentClientChartBody(from_, until, currency)
