...
from portone_server_sdk._generated.payment_schedule.already_paid_or_waiting_error import AlreadyPaidOrWaitingError, _deserialize_already_paid_or_waiting_error, _serialize_already_paid_or_waiting_error
...
from portone_server_sdk._generated.payment_schedule.create_payment_schedule_response import CreatePaymentScheduleResponse, _deserialize_create_payment_schedule_response, _serialize_create_payment_schedule_response
from portone_server_sdk._generated.common.forbidden_error import ForbiddenError, _deserialize_forbidden_error, _serialize_forbidden_error
from portone_server_sdk._generated.payment_schedule.get_payment_schedules_response import GetPaymentSchedulesResponse, _deserialize_get_payment_schedules_response, _serialize_get_payment_schedules_response
...
from portone_server_sdk._generated.payment_schedule.payment_schedule import PaymentSchedule, _deserialize_payment_schedule, _serialize_payment_schedule
...
from portone_server_sdk._generated.payment_schedule.payment_schedule_already_processed_error import PaymentScheduleAlreadyProcessedError, _deserialize_payment_schedule_already_processed_error, _serialize_payment_schedule_already_processed_error
from portone_server_sdk._generated.payment_schedule.payment_schedule_already_revoked_error import PaymentScheduleAlreadyRevokedError, _deserialize_payment_schedule_already_revoked_error, _serialize_payment_schedule_already_revoked_error
from portone_server_sdk._generated.payment_schedule.payment_schedule_filter_input import PaymentScheduleFilterInput, _deserialize_payment_schedule_filter_input, _serialize_payment_schedule_filter_input
from portone_server_sdk._generated.payment_schedule.payment_schedule_not_found_error import PaymentScheduleNotFoundError, _deserialize_payment_schedule_not_found_error, _serialize_payment_schedule_not_found_error
from portone_server_sdk._generated.payment_schedule.payment_schedule_sort_input import PaymentScheduleSortInput, _deserialize_payment_schedule_sort_input, _serialize_payment_schedule_sort_input
from portone_server_sdk._generated.payment_schedule.revoke_payment_schedules_response import RevokePaymentSchedulesResponse, _deserialize_revoke_payment_schedules_response, _serialize_revoke_payment_schedules_response
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "PAYMENT_SCHEDULE_NOT_FOUND":
                raise errors.PaymentScheduleNotFoundError(_serialize_payment_schedule_not_found_error(error_response))
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "PAYMENT_SCHEDULE_ALREADY_PROCESSED":
                raise errors.PaymentScheduleAlreadyProcessedError(_serialize_payment_schedule_already_processed_error(error_response))
            if error_type == "PAYMENT_SCHEDULE_ALREADY_REVOKED":
                raise errors.PaymentScheduleAlreadyRevokedError(_serialize_payment_schedule_already_revoked_error(error_response))
            if error_type == "PAYMENT_SCHEDULE_NOT_FOUND":
                raise errors.PaymentScheduleNotFoundError(_serialize_payment_schedule_not_found_error(error_response))
            if error_type == "UNAUTHORIZED":
                raise errors.UnauthorizedError(_serialize_unauthorized_error(error_response))
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "ALREADY_PAID_OR_WAITING":
                raise errors.AlreadyPaidOrWaitingError(_serialize_already_paid_or_waiting_error(error_response))
            if error_type == "BILLING_KEY_ALREADY_DELETED":
                raise errors.BillingKeyAlreadyDeletedError(_serialize_billing_key_already_deleted_error(error_response))
            if error_type == "BILLING_KEY_NOT_FOUND":
                raise errors.BillingKeyNotFoundError(_serialize_billing_key_not_found_error(error_response))
            ...
            if error_type == "PAYMENT_SCHEDULE_ALREADY_EXISTS":
                raise errors.PaymentScheduleAlreadyExistsError(_serialize_payment_schedule_already_exists_error(error_response))
