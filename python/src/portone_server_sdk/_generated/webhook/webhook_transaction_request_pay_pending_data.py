...
@dataclass
class WebhookTransactionRequestPayPendingData:
    payment_id: str
...
def _serialize_webhook_transaction_request_pay_pending_data(obj: WebhookTransactionRequestPayPendingData) -> Any:
    entity = {}
...
def _deserialize_webhook_transaction_request_pay_pending_data(obj: Any) -> WebhookTransactionRequestPayPendingData:
    ...
    return WebhookTransactionRequestPayPendingData(payment_id, transaction_id)
