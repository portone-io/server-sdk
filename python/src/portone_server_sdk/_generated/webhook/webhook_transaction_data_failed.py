...
@dataclass
class WebhookTransactionDataFailed:
...
def _deserialize_webhook_transaction_data_failed(obj: Any) -> WebhookTransactionDataFailed:
    ...
    return WebhookTransactionDataFailed(payment_id, store_id, transaction_id)
