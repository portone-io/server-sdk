...
@dataclass
class WebhookTransactionCancelledDataPartialCancelled:
...
def _deserialize_webhook_transaction_cancelled_data_partial_cancelled(obj: Any) -> WebhookTransactionCancelledDataPartialCancelled:
    ...
    return WebhookTransactionCancelledDataPartialCancelled(payment_id, store_id, transaction_id, cancellation_id)
