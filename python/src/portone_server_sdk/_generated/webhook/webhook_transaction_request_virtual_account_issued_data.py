...
@dataclass
class WebhookTransactionRequestVirtualAccountIssuedData:
    payment_id: str
...
def _serialize_webhook_transaction_request_virtual_account_issued_data(obj: WebhookTransactionRequestVirtualAccountIssuedData) -> Any:
    entity = {}
...
def _deserialize_webhook_transaction_request_virtual_account_issued_data(obj: Any) -> WebhookTransactionRequestVirtualAccountIssuedData:
    ...
    return WebhookTransactionRequestVirtualAccountIssuedData(payment_id, transaction_id)
