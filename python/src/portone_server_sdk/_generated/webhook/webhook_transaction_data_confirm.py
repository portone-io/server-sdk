...
@dataclass
class WebhookTransactionDataConfirm:
...
def _deserialize_webhook_transaction_data_confirm(obj: Any) -> WebhookTransactionDataConfirm:
    ...
    return WebhookTransactionDataConfirm(payment_id, store_id, transaction_id, total_amount)
