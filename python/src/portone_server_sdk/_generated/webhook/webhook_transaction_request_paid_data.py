...
@dataclass
class WebhookTransactionRequestPaidData:
    payment_id: str
...
def _serialize_webhook_transaction_request_paid_data(obj: WebhookTransactionRequestPaidData) -> Any:
    entity = {}
...
def _deserialize_webhook_transaction_request_paid_data(obj: Any) -> WebhookTransactionRequestPaidData:
    ...
    return WebhookTransactionRequestPaidData(payment_id, transaction_id)
