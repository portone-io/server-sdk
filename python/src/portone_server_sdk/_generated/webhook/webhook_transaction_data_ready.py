...
@dataclass
class WebhookTransactionDataReady:
...
def _deserialize_webhook_transaction_data_ready(obj: Any) -> WebhookTransactionDataReady:
    ...
    return WebhookTransactionDataReady(payment_id, store_id, transaction_id)
