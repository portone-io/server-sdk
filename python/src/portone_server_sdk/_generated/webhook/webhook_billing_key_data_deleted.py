...
@dataclass
class WebhookBillingKeyDataDeleted:
...
def _deserialize_webhook_billing_key_data_deleted(obj: Any) -> WebhookBillingKeyDataDeleted:
    ...
    return WebhookBillingKeyDataDeleted(billing_key, store_id)
