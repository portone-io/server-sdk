...
@dataclass
class WebhookTransactionRequestReadyData:
    payment_id: str
...
def _serialize_webhook_transaction_request_ready_data(obj: WebhookTransactionRequestReadyData) -> Any:
    entity = {}
...
def _deserialize_webhook_transaction_request_ready_data(obj: Any) -> WebhookTransactionRequestReadyData:
    ...
    return WebhookTransactionRequestReadyData(payment_id, transaction_id)
