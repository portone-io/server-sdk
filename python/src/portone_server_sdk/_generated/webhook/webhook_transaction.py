...
WebhookTransaction = Union[WebhookTransactionReady, WebhookTransactionPaid, WebhookTransactionVirtualAccountIssued, WebhookTransactionFailed, WebhookTransactionPayPending, WebhookTransactionCancelled]
