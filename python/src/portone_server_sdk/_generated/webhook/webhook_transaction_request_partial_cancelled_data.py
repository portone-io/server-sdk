...
@dataclass
class WebhookTransactionRequestPartialCancelledData:
    payment_id: str
...
def _serialize_webhook_transaction_request_partial_cancelled_data(obj: WebhookTransactionRequestPartialCancelledData) -> Any:
    entity = {}
...
def _deserialize_webhook_transaction_request_partial_cancelled_data(obj: Any) -> WebhookTransactionRequestPartialCancelledData:
    ...
    return WebhookTransactionRequestPartialCancelledData(payment_id, transaction_id, cancellation_id)
