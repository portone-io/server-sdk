...
def _deserialize_webhook_transaction_cancel_pending(obj: Any) -> WebhookTransactionCancelPending:
    ...
    data = obj["data"]
    data = _deserialize_webhook_transaction_data_cancel_pending(data)
    return WebhookTransactionCancelPending(timestamp, data)
