...
@dataclass
class WebhookTransactionDataPayPending:
...
def _deserialize_webhook_transaction_data_pay_pending(obj: Any) -> WebhookTransactionDataPayPending:
    ...
    return WebhookTransactionDataPayPending(payment_id, store_id, transaction_id)
