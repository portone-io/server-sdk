...
@dataclass
class WebhookTransactionDataPaid:
...
def _deserialize_webhook_transaction_data_paid(obj: Any) -> WebhookTransactionDataPaid:
    ...
    return WebhookTransactionDataPaid(payment_id, store_id, transaction_id)
