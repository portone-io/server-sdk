...
@dataclass
class WebhookTransactionRequestFailedData:
    payment_id: str
...
def _serialize_webhook_transaction_request_failed_data(obj: WebhookTransactionRequestFailedData) -> Any:
    entity = {}
...
def _deserialize_webhook_transaction_request_failed_data(obj: Any) -> WebhookTransactionRequestFailedData:
    ...
    return WebhookTransactionRequestFailedData(payment_id, transaction_id)
