...
from portone_server_sdk._generated.promotion.promotion import Promotion, _deserialize_promotion, _serialize_promotion
from portone_server_sdk._generated.promotion.promotion_not_found_error import PromotionNotFoundError, _deserialize_promotion_not_found_error, _serialize_promotion_not_found_error
        ...
        *,
        ...
        if response.status_code != 200:
            ...
            if error_type == "PROMOTION_NOT_FOUND":
                raise errors.PromotionNotFoundError(_serialize_promotion_not_found_error(error_response))
