...
import type { PaymentReconciliationNotMatchedReason } from "#generated/platform/PaymentReconciliationNotMatchedReason"
...
export type PaymentReconciliationNotMatched = {
	status: "NOT_MATCHED"
	/** 거래대사 아이디 */
	id: string
	graphqlId: string
