import type { WebhookTransactionRequestPayPendingData } from "./../webhook/WebhookTransactionRequestPayPendingData"

/** 결제 승인 대기 상태가 되었을 때 (해외 결제시 발생 가능) */
export type WebhookTransactionRequestPayPending = {
	/** 웹훅을 트리거한 이벤트의 타입입니다. */
