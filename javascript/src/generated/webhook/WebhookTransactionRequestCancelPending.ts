import type { WebhookTransactionRequestCancelPendingData } from "./../webhook/WebhookTransactionRequestCancelPendingData"

/** (결제 취소가 비동기로 수행되는 경우) 결제 취소를 요청했을 때 */
export type WebhookTransactionRequestCancelPending = {
	/** 웹훅을 트리거한 이벤트의 타입입니다. */
