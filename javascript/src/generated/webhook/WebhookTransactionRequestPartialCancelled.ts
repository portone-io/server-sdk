import type { WebhookTransactionRequestPartialCancelledData } from "./../webhook/WebhookTransactionRequestPartialCancelledData"

/** 결제가 부분 취소되었을 때 */
export type WebhookTransactionRequestPartialCancelled = {
	/** 웹훅을 트리거한 이벤트의 타입입니다. */
