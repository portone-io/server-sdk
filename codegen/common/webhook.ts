...
const webhookTransactionDataVariants = [
  ...
  extendType({
    name: "WebhookTransactionDataChargebackCreated",
    description: "차지백이 제기되었을 때 이벤트의 실제 세부 내용입니다.",
    type: "object",
    properties: [],
    interface: null,
  }, webhookTransactionData),
  extendType({
    name: "WebhookTransactionDataChargebackResolved",
    description: "차지백이 해소되었을 때 이벤트의 실제 세부 내용입니다.",
    type: "object",
    properties: [],
    interface: null,
  }, webhookTransactionData),
...
const webhookTransactionVariants = [
  ...
  extendType({
    name: "WebhookTransactionChargebackCreated",
    description: "차지백이 제기되었을 때",
    type: "object",
    properties: [{
      name: "type",
      description: "웹훅을 트리거한 이벤트의 타입입니다.",
      ...
      overrides: true,
      type: "discriminant",
      value: "Transaction.ChargebackCreated",
    }, {
      name: "data",
      description: "차지백이 제기되었을 때 이벤트의 실제 세부 내용입니다.",
      required: true,
      overrides: true,
      type: "ref",
      value: "WebhookTransactionDataChargebackCreated",
    }],
    interface: null,
  }, webhookTransaction),
  extendType({
    name: "WebhookTransactionChargebackResolved",
    description: "차지백이 해소되었을 때",
    type: "object",
    properties: [{
      name: "type",
      description: "웹훅을 트리거한 이벤트의 타입입니다.",
      ...
      overrides: true,
      type: "discriminant",
      value: "Transaction.ChargebackResolved",
    }, {
      name: "data",
      description: "차지백이 해소되었을 때 이벤트의 실제 세부 내용입니다.",
      required: true,
      overrides: true,
      type: "ref",
      value: "WebhookTransactionDataChargebackResolved",
    }],
    interface: null,
  }, webhookTransaction),
  extendType({
