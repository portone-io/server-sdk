...
import io.portone.sdk.server.BillingKeyInfo
import io.portone.sdk.server.DeleteBillingKeyResponse
import io.portone.sdk.server.GetBillingKeyInfosResponse
import io.portone.sdk.server.IssueBillingKeyResponse
...
import io.portone.sdk.server.billingkey.DeleteBillingKeyResponse
import io.portone.sdk.server.billingkey.GetBillingKeyInfosResponse
import io.portone.sdk.server.billingkey.InstantBillingKeyPaymentMethodInput
import io.portone.sdk.server.billingkey.IssueBillingKeyResponse
...
public class BillingKeyClient(
  ...
  public suspend fun getBillingKeyInfo(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("billing-keys", billingKey)
