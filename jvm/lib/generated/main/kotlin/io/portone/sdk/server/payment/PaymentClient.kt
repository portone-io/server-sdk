...
import io.portone.sdk.server.ApplyEscrowLogisticsResponse
import io.portone.sdk.server.CancelPaymentResponse
import io.portone.sdk.server.CloseVirtualAccountResponse
import io.portone.sdk.server.ConfirmEscrowResponse
import io.portone.sdk.server.GetAllPaymentsByCursorResponse
import io.portone.sdk.server.GetPaymentsResponse
import io.portone.sdk.server.ModifyEscrowLogisticsResponse
import io.portone.sdk.server.PayInstantlyResponse
import io.portone.sdk.server.PayWithBillingKeyResponse
import io.portone.sdk.server.Payment
import io.portone.sdk.server.PreRegisterPaymentResponse
import io.portone.sdk.server.RegisterStoreReceiptResponse
import io.portone.sdk.server.ResendWebhookResponse
...
public class PaymentClient(
  ...
  public suspend fun preRegisterPayment(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "pre-register")
      }
      headers {
  ...
  public suspend fun getPayment(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId)
  ...
  public suspend fun cancelPayment(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "cancel")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
  ...
  public suspend fun payWithBillingKey(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "billing-key")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
  ...
  public suspend fun payInstantly(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "instant")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
  ...
  public suspend fun closeVirtualAccount(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "virtual-account", "close")
        if (storeId != null) parameters.append("storeId", storeId)
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
  ...
  public suspend fun applyEscrowLogistics(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "escrow", "logistics")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
  ...
  public suspend fun confirmEscrow(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "escrow", "complete")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
  ...
  public suspend fun resendWebhook(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "resend-webhook")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
  ...
  public suspend fun registerStoreReceipt(
    ...
    val httpResponse = client.get(apiBase) {
      url {
        appendPathSegments("payments", paymentId, "register-store-receipt")
      }
      headers {
        append(HttpHeaders.Authorization, "PortOne $apiSecret")
      }
