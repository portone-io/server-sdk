...
public sealed interface PromotionStatus {
  ...
  public object PausedSerializer : KSerializer<Paused> {
    ...
    override fun serialize(encoder: Encoder, value: Paused): Unit = encoder.encodeString(value.value)
  }
  /** 예산 소진됨 */
  ...
  public object BudgetExhaustedSerializer : KSerializer<BudgetExhausted> {
    ...
    override fun serialize(encoder: Encoder, value: BudgetExhausted): Unit = encoder.encodeString(value.value)
  }
  /** 중단됨 */
  ...
  public object TerminatedSerializer : KSerializer<Terminated> {
    ...
    override fun serialize(encoder: Encoder, value: Terminated): Unit = encoder.encodeString(value.value)
  }
  /** 완료됨 */
...
public object PromotionStatusSerializer : KSerializer<PromotionStatus> {
  ...
  override fun serialize(encoder: Encoder, value: PromotionStatus): Unit = encoder.encodeString(value.value)
}
