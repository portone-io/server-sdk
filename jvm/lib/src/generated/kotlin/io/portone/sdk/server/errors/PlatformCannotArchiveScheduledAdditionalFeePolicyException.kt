...
public class PlatformCannotArchiveScheduledAdditionalFeePolicyException internal constructor(
  cause: PlatformCannotArchiveScheduledAdditionalFeePolicyError
) : PortOneException(cause.message), ArchivePlatformAdditionalFeePolicyException {
}
