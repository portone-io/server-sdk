...
internal object ConfirmEscrowErrorSerializer : JsonContentPolymorphicSerializer<ConfirmEscrowError>(ConfirmEscrowError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out ConfirmEscrowError> =
