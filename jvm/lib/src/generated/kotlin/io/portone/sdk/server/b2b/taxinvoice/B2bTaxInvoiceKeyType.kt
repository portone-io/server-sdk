...
public sealed interface B2bTaxInvoiceKeyType {
  ...
  public object SupplierSerializer : KSerializer<Supplier> {
    ...
    override fun serialize(encoder: Encoder, value: Supplier): Unit = encoder.encodeString(value.value)
  }
  /** 공급받는자용 문서 번호 */
  ...
  public object RecipientSerializer : KSerializer<Recipient> {
    ...
    override fun serialize(encoder: Encoder, value: Recipient): Unit = encoder.encodeString(value.value)
  }
  /** 세금계산서 아이디 */
  ...
  public object TaxInvoiceIdSerializer : KSerializer<TaxInvoiceId> {
    ...
    override fun serialize(encoder: Encoder, value: TaxInvoiceId): Unit = encoder.encodeString(value.value)
  }
...
public object B2bTaxInvoiceKeyTypeSerializer : KSerializer<B2bTaxInvoiceKeyType> {
  ...
  override fun serialize(encoder: Encoder, value: B2bTaxInvoiceKeyType): Unit = encoder.encodeString(value.value)
}
