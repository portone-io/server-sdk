...
internal object GetKakaopayPaymentOrderErrorSerializer : JsonContentPolymorphicSerializer<GetKakaopayPaymentOrderError>(GetKakaopayPaymentOrderError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out GetKakaopayPaymentOrderError> =
