...
private object B2bCompanyStateBusinessStatusSerializer : KSerializer<B2bCompanyStateBusinessStatus> {
  ...
  override fun serialize(encoder: Encoder, value: B2bCompanyStateBusinessStatus) = encoder.encodeString(value.value)
}
