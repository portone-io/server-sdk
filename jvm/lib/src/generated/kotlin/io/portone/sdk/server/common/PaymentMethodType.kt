...
public sealed interface PaymentMethodType {
  ...
  public object GiftCertificateSerializer : KSerializer<GiftCertificate> {
    ...
    override fun serialize(encoder: Encoder, value: GiftCertificate): Unit = encoder.encodeString(value.value)
  }
  ...
  public object ConvenienceStoreSerializer : KSerializer<ConvenienceStore> {
    ...
    override fun serialize(encoder: Encoder, value: ConvenienceStore): Unit = encoder.encodeString(value.value)
  }
  @Serializable(CryptoSerializer::class)
  public data object Crypto : PaymentMethodType {
    override val value: String = "CRYPTO"
  }
  public object CryptoSerializer : KSerializer<Crypto> {
    ...
    override fun serialize(encoder: Encoder, value: Crypto): Unit = encoder.encodeString(value.value)
  }
...
public object PaymentMethodTypeSerializer : KSerializer<PaymentMethodType> {
  ...
  override fun serialize(encoder: Encoder, value: PaymentMethodType): Unit = encoder.encodeString(value.value)
}
