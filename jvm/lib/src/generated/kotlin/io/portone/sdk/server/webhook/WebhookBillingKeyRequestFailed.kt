...
import io.portone.sdk.server.webhook.WebhookBillingKeyRequestFailedData
...
public data class WebhookBillingKeyRequestFailed(
  ...
  val data: WebhookBillingKeyRequestFailedData,
): WebhookRequest
