...
internal sealed interface UpdatePlatformPartnerError {
  @Serializable
...
internal object UpdatePlatformPartnerErrorSerializer : JsonContentPolymorphicSerializer<UpdatePlatformPartnerError>(UpdatePlatformPartnerError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out UpdatePlatformPartnerError> =
