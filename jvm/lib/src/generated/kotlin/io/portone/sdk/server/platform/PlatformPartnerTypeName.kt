...
public object PlatformPartnerTypeNameSerializer : KSerializer<PlatformPartnerTypeName> {
  ...
  override fun serialize(encoder: Encoder, value: PlatformPartnerTypeName): Unit = encoder.encodeString(value.value)
}
