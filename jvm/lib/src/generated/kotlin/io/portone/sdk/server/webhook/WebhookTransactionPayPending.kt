...
import io.portone.sdk.server.webhook.WebhookTransactionDataPayPending
...
@Serializable
@SerialName("Transaction.PayPending")
public data class WebhookTransactionPayPending internal constructor(
  ...
  override val data: WebhookTransactionDataPayPending,
) : WebhookTransaction
