...
import io.portone.sdk.server.webhook.WebhookTransactionRequestPaidData
...
@Serializable
@SerialName("Transaction.Paid")
public data class WebhookTransactionRequestPaid(
  ...
  val data: WebhookTransactionRequestPaidData,
): WebhookRequest
