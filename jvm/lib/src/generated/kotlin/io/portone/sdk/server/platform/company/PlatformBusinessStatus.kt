...
public object PlatformBusinessStatusSerializer : KSerializer<PlatformBusinessStatus> {
  ...
  override fun serialize(encoder: Encoder, value: PlatformBusinessStatus): Unit = encoder.encodeString(value.value)
}
