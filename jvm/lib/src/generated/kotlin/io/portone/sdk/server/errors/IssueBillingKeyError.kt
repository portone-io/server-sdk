...
internal object IssueBillingKeyErrorSerializer : JsonContentPolymorphicSerializer<IssueBillingKeyError>(IssueBillingKeyError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out IssueBillingKeyError> =
