...
public sealed interface CancelPaymentError {
  @Serializable
...
private object CancelPaymentErrorSerializer : JsonContentPolymorphicSerializer<CancelPaymentError>(CancelPaymentError::class) {
  override fun selectDeserializer(element: JsonElement) = when (element.jsonObject["type"]?.jsonPrimitive?.contentOrNull) {
    ...
    "REMAINED_AMOUNT_LESS_THAN_PROMOTION_MIN_PAYMENT_AMOUNT" -> RemainedAmountLessThanPromotionMinPaymentAmountError.serializer()
