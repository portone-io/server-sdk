...
internal object CapturePaymentErrorSerializer : JsonContentPolymorphicSerializer<CapturePaymentError>(CapturePaymentError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out CapturePaymentError> =
