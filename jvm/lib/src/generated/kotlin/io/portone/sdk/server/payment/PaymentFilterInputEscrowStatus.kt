...
public sealed interface PaymentFilterInputEscrowStatus {
  ...
  public object RegisteredSerializer : KSerializer<Registered> {
    ...
    override fun serialize(encoder: Encoder, value: Registered): Unit = encoder.encodeString(value.value)
  }
  ...
  public object RejectConfirmedSerializer : KSerializer<RejectConfirmed> {
    ...
    override fun serialize(encoder: Encoder, value: RejectConfirmed): Unit = encoder.encodeString(value.value)
  }
...
public object PaymentFilterInputEscrowStatusSerializer : KSerializer<PaymentFilterInputEscrowStatus> {
  ...
  override fun serialize(encoder: Encoder, value: PaymentFilterInputEscrowStatus): Unit = encoder.encodeString(value.value)
}
