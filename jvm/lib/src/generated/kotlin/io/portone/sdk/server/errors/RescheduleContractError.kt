...
internal object RescheduleContractErrorSerializer : JsonContentPolymorphicSerializer<RescheduleContractError>(RescheduleContractError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out RescheduleContractError> =
