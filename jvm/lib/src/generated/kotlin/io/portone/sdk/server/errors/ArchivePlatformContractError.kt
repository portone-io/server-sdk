...
internal sealed interface ArchivePlatformContractError {
  @Serializable
...
internal object ArchivePlatformContractErrorSerializer : JsonContentPolymorphicSerializer<ArchivePlatformContractError>(ArchivePlatformContractError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out ArchivePlatformContractError> =
