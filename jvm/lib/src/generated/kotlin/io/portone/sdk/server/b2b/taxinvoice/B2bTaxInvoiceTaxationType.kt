...
public sealed interface B2bTaxInvoiceTaxationType {
  ...
  private object TaxableSerializer : KSerializer<Taxable> {
    ...
    override fun serialize(encoder: Encoder, value: Taxable) = encoder.encodeString(value.value)
  }
  /** 영세 */
  ...
  private object ZeroRatedSerializer : KSerializer<ZeroRated> {
    ...
    override fun serialize(encoder: Encoder, value: ZeroRated) = encoder.encodeString(value.value)
  }
  /** 면세 */
  ...
  private object FreeSerializer : KSerializer<Free> {
    ...
    override fun serialize(encoder: Encoder, value: Free) = encoder.encodeString(value.value)
  }
...
private object B2bTaxInvoiceTaxationTypeSerializer : KSerializer<B2bTaxInvoiceTaxationType> {
  ...
  override fun serialize(encoder: Encoder, value: B2bTaxInvoiceTaxationType) = encoder.encodeString(value.value)
}
