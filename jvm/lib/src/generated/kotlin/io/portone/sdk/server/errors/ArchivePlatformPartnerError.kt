...
internal sealed interface ArchivePlatformPartnerError {
  @Serializable
...
internal object ArchivePlatformPartnerErrorSerializer : JsonContentPolymorphicSerializer<ArchivePlatformPartnerError>(ArchivePlatformPartnerError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out ArchivePlatformPartnerError> =
