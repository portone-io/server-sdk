...
internal sealed interface ArchivePlatformDiscountSharePolicyError {
  @Serializable
...
internal object ArchivePlatformDiscountSharePolicyErrorSerializer : JsonContentPolymorphicSerializer<ArchivePlatformDiscountSharePolicyError>(ArchivePlatformDiscountSharePolicyError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out ArchivePlatformDiscountSharePolicyError> =
