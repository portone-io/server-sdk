...
internal object CloseVirtualAccountErrorSerializer : JsonContentPolymorphicSerializer<CloseVirtualAccountError>(CloseVirtualAccountError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out CloseVirtualAccountError> =
