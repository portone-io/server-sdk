...
import io.portone.sdk.server.webhook.WebhookBillingKeyRequestReadyData
...
/** 빌링키 발급창이 열렸을 때 */
@Serializable
@SerialName("BillingKey.Ready")
public data class WebhookBillingKeyRequestReady(
  ...
  val data: WebhookBillingKeyRequestReadyData,
): WebhookRequest
