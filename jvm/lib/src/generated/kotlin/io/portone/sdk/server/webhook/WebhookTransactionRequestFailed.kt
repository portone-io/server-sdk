...
import io.portone.sdk.server.webhook.WebhookTransactionRequestFailedData
...
public data class WebhookTransactionRequestFailed(
  ...
  val data: WebhookTransactionRequestFailedData,
): WebhookRequest
