...
import io.portone.sdk.server.webhook.WebhookBillingKeyDataUpdated
...
/** 빌링키가 업데이트되었을 때 */
@Serializable
@SerialName("BillingKey.Updated")
public data class WebhookBillingKeyUpdated internal constructor(
  ...
  override val data: WebhookBillingKeyDataUpdated,
) : WebhookBillingKey
