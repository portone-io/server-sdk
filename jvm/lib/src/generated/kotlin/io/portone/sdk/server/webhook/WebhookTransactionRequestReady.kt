...
import io.portone.sdk.server.webhook.WebhookTransactionRequestReadyData
...
public data class WebhookTransactionRequestReady(
  ...
  val data: WebhookTransactionRequestReadyData,
): WebhookRequest
