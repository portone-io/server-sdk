...
public object PromotionCardCompanySerializer : KSerializer<PromotionCardCompany> {
  ...
  override fun serialize(encoder: Encoder, value: PromotionCardCompany): Unit = encoder.encodeString(value.value)
}
