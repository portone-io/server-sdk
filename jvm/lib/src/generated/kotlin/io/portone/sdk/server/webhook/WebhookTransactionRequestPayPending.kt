...
import io.portone.sdk.server.webhook.WebhookTransactionRequestPayPendingData
...
public data class WebhookTransactionRequestPayPending(
  ...
  val data: WebhookTransactionRequestPayPendingData,
): WebhookRequest
