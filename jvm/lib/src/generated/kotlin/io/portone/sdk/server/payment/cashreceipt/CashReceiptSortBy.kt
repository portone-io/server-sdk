...
public object CashReceiptSortBySerializer : KSerializer<CashReceiptSortBy> {
  ...
  override fun serialize(encoder: Encoder, value: CashReceiptSortBy): Unit = encoder.encodeString(value.value)
}
