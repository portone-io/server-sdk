...
internal sealed interface RecoverPlatformContractError {
  @Serializable
...
internal object RecoverPlatformContractErrorSerializer : JsonContentPolymorphicSerializer<RecoverPlatformContractError>(RecoverPlatformContractError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out RecoverPlatformContractError> =
