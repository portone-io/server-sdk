...
internal sealed interface ScheduleContractError {
  @Serializable
...
internal object ScheduleContractErrorSerializer : JsonContentPolymorphicSerializer<ScheduleContractError>(ScheduleContractError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out ScheduleContractError> =
