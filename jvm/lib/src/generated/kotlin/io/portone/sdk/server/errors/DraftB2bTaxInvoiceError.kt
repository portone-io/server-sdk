...
@Serializable(DraftB2bTaxInvoiceErrorSerializer::class)
internal sealed interface DraftB2bTaxInvoiceError {
  @Serializable
  @JsonClassDiscriminator("type")
  /** 현재 SDK 버전에서 처리 가능한 응답을 나타냅니다. */
  public sealed interface Recognized : DraftB2bTaxInvoiceError {
    public val message: String?
  }
  /** 현재 SDK 버전에서 알 수 없는 응답을 나타냅니다. */
  @Serializable
  public data object Unrecognized : DraftB2bTaxInvoiceError
}


internal object DraftB2bTaxInvoiceErrorSerializer : JsonContentPolymorphicSerializer<DraftB2bTaxInvoiceError>(DraftB2bTaxInvoiceError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out DraftB2bTaxInvoiceError> =
    when (element.jsonObject["type"]?.jsonPrimitive?.contentOrNull) {
      ...
      else -> DraftB2bTaxInvoiceError.Unrecognized.serializer()
    }
}
