...
internal object GetPaymentSchedulesErrorSerializer : JsonContentPolymorphicSerializer<GetPaymentSchedulesError>(GetPaymentSchedulesError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out GetPaymentSchedulesError> =
