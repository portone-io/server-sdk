...
import io.portone.sdk.server.webhook.WebhookTransactionRequestCancelledData
...
/** 결제가 완전 취소되었을 때 */
@Serializable
@SerialName("Transaction.Cancelled")
public data class WebhookTransactionRequestCancelled(
  ...
  val data: WebhookTransactionRequestCancelledData,
): WebhookRequest
