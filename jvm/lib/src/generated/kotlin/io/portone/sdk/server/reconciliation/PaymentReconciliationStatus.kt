...
public sealed interface PaymentReconciliationStatus {
  ...
  public object MatchedSerializer : KSerializer<Matched> {
    ...
    override fun serialize(encoder: Encoder, value: Matched): Unit = encoder.encodeString(value.value)
  }
  /** 대사 매칭 실패 상태 */
  ...
  public object NotMatchedSerializer : KSerializer<NotMatched> {
    ...
    override fun serialize(encoder: Encoder, value: NotMatched): Unit = encoder.encodeString(value.value)
  }
  /** 대사 불가능 상태 */
  ...
  public object IncomparableSerializer : KSerializer<Incomparable> {
    ...
    override fun serialize(encoder: Encoder, value: Incomparable): Unit = encoder.encodeString(value.value)
  }
  ...
  public object NotCollectedSerializer : KSerializer<NotCollected> {
    ...
    override fun serialize(encoder: Encoder, value: NotCollected): Unit = encoder.encodeString(value.value)
  }
...
public object PaymentReconciliationStatusSerializer : KSerializer<PaymentReconciliationStatus> {
  ...
  override fun serialize(encoder: Encoder, value: PaymentReconciliationStatus): Unit = encoder.encodeString(value.value)
}
