...
internal object GetPaymentErrorSerializer : JsonContentPolymorphicSerializer<GetPaymentError>(GetPaymentError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out GetPaymentError> =
