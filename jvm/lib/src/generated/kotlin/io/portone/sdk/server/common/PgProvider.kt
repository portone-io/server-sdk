...
public sealed interface PgProvider {
  ...
  public object Html5InicisSerializer : KSerializer<Html5Inicis> {
    ...
    override fun serialize(encoder: Encoder, value: Html5Inicis): Unit = encoder.encodeString(value.value)
  }
  ...
  public object PaypalV2Serializer : KSerializer<PaypalV2> {
    ...
    override fun serialize(encoder: Encoder, value: PaypalV2): Unit = encoder.encodeString(value.value)
  }
  ...
  public object DanalTpaySerializer : KSerializer<DanalTpay> {
    ...
    override fun serialize(encoder: Encoder, value: DanalTpay): Unit = encoder.encodeString(value.value)
  }
  ...
  public object NavercoSerializer : KSerializer<Naverco> {
    ...
    override fun serialize(encoder: Encoder, value: Naverco): Unit = encoder.encodeString(value.value)
  }
  ...
  public object KcpBillingSerializer : KSerializer<KcpBilling> {
    ...
    override fun serialize(encoder: Encoder, value: KcpBilling): Unit = encoder.encodeString(value.value)
  }
  ...
  public object SmartroV2Serializer : KSerializer<SmartroV2> {
    ...
    override fun serialize(encoder: Encoder, value: SmartroV2): Unit = encoder.encodeString(value.value)
  }
  ...
  public object KcpQuickSerializer : KSerializer<KcpQuick> {
    ...
    override fun serialize(encoder: Encoder, value: KcpQuick): Unit = encoder.encodeString(value.value)
  }
  ...
  public object KcpDirectSerializer : KSerializer<KcpDirect> {
    ...
    override fun serialize(encoder: Encoder, value: KcpDirect): Unit = encoder.encodeString(value.value)
  }
  @Serializable(SettleAccSerializer::class)
  public data object SettleAcc : PgProvider {
    override val value: String = "SETTLE_ACC"
  }
  public object SettleAccSerializer : KSerializer<SettleAcc> {
    ...
    override fun serialize(encoder: Encoder, value: SettleAcc): Unit = encoder.encodeString(value.value)
  }
  @Serializable(SettleFirmSerializer::class)
  public data object SettleFirm : PgProvider {
    override val value: String = "SETTLE_FIRM"
  }
  public object SettleFirmSerializer : KSerializer<SettleFirm> {
    ...
    override fun serialize(encoder: Encoder, value: SettleFirm): Unit = encoder.encodeString(value.value)
  }
  ...
  public object InicisUnifiedSerializer : KSerializer<InicisUnified> {
    ...
    override fun serialize(encoder: Encoder, value: InicisUnified): Unit = encoder.encodeString(value.value)
  }
  ...
  public object NiceV2Serializer : KSerializer<NiceV2> {
    ...
    override fun serialize(encoder: Encoder, value: NiceV2): Unit = encoder.encodeString(value.value)
  }
  ...
  public object TosspayV2Serializer : KSerializer<TosspayV2> {
    ...
    override fun serialize(encoder: Encoder, value: TosspayV2): Unit = encoder.encodeString(value.value)
  }
  @Serializable(InicisV2Serializer::class)
  public data object InicisV2 : PgProvider {
    override val value: String = "INICIS_V2"
  }
  public object InicisV2Serializer : KSerializer<InicisV2> {
    ...
    override fun serialize(encoder: Encoder, value: InicisV2): Unit = encoder.encodeString(value.value)
  }
  ...
  public object KcpV2Serializer : KSerializer<KcpV2> {
    ...
    override fun serialize(encoder: Encoder, value: KcpV2): Unit = encoder.encodeString(value.value)
  }
  ...
  public object EximbayV2Serializer : KSerializer<EximbayV2> {
    ...
    override fun serialize(encoder: Encoder, value: EximbayV2): Unit = encoder.encodeString(value.value)
  }
  @Serializable(InicisJpSerializer::class)
  public data object InicisJp : PgProvider {
    override val value: String = "INICIS_JP"
  }
  public object InicisJpSerializer : KSerializer<InicisJp> {
    ...
    override fun serialize(encoder: Encoder, value: InicisJp): Unit = encoder.encodeString(value.value)
  }
  ...
  public object MobiliansV2Serializer : KSerializer<MobiliansV2> {
    ...
    override fun serialize(encoder: Encoder, value: MobiliansV2): Unit = encoder.encodeString(value.value)
  }
  ...
  public data object Innopay : PgProvider {
  ...
  @Serializable(HectoGlobalSerializer::class)
  public data object HectoGlobal : PgProvider {
    override val value: String = "HECTO_GLOBAL"
  }
  public object HectoGlobalSerializer : KSerializer<HectoGlobal> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor(HectoGlobal::class.java.name, PrimitiveKind.STRING)
    override fun deserialize(decoder: Decoder): HectoGlobal = decoder.decodeString().let {
      if (it != "HECTO_GLOBAL") {
        throw SerializationException(it)
      } else {
        return HectoGlobal
    ...
    override fun serialize(encoder: Encoder, value: HectoGlobal): Unit = encoder.encodeString(value.value)
  }
...
public object PgProviderSerializer : KSerializer<PgProvider> {
  ...
  override fun deserialize(decoder: Decoder): PgProvider {
    ...
    return when (value) {
      ...
      "INNOPAY" -> PgProvider.Innopay
      "HECTO_GLOBAL" -> PgProvider.HectoGlobal
      else -> PgProvider.Unrecognized(value)
    }
  }
  override fun serialize(encoder: Encoder, value: PgProvider): Unit = encoder.encodeString(value.value)
}
