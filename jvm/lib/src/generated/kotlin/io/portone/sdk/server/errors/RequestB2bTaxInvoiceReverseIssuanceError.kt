...
@Serializable(RequestB2bTaxInvoiceReverseIssuanceErrorSerializer::class)
internal sealed interface RequestB2bTaxInvoiceReverseIssuanceError {
  @Serializable
  @JsonClassDiscriminator("type")
  /** 현재 SDK 버전에서 처리 가능한 응답을 나타냅니다. */
  public sealed interface Recognized : RequestB2bTaxInvoiceReverseIssuanceError {
    public val message: String?
  }
  /** 현재 SDK 버전에서 알 수 없는 응답을 나타냅니다. */
  @Serializable
  public data object Unrecognized : RequestB2bTaxInvoiceReverseIssuanceError
}
