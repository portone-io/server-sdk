...
internal object GetPaymentScheduleErrorSerializer : JsonContentPolymorphicSerializer<GetPaymentScheduleError>(GetPaymentScheduleError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out GetPaymentScheduleError> =
