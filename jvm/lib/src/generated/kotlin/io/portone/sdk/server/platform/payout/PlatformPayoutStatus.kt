...
public object PlatformPayoutStatusSerializer : KSerializer<PlatformPayoutStatus> {
  ...
  override fun serialize(encoder: Encoder, value: PlatformPayoutStatus): Unit = encoder.encodeString(value.value)
}
