...
internal sealed interface DeletePlatformTransferError {
  @Serializable
...
internal object DeletePlatformTransferErrorSerializer : JsonContentPolymorphicSerializer<DeletePlatformTransferError>(DeletePlatformTransferError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out DeletePlatformTransferError> =
