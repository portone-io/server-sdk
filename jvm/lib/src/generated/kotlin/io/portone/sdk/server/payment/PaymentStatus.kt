...
public object PaymentStatusSerializer : KSerializer<PaymentStatus> {
  ...
  override fun serialize(encoder: Encoder, value: PaymentStatus): Unit = encoder.encodeString(value.value)
}
