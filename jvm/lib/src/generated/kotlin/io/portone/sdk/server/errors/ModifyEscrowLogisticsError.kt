...
internal object ModifyEscrowLogisticsErrorSerializer : JsonContentPolymorphicSerializer<ModifyEscrowLogisticsError>(ModifyEscrowLogisticsError::class) {
  override fun selectDeserializer(element: JsonElement): KSerializer<out ModifyEscrowLogisticsError> =
