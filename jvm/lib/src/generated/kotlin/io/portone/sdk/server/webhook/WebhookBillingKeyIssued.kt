...
import io.portone.sdk.server.webhook.WebhookBillingKeyDataIssued
...
/** 빌링키가 발급되었을 때 */
@Serializable
@SerialName("BillingKey.Issued")
@ConsistentCopyVisibility
public data class WebhookBillingKeyIssued internal constructor(
  ...
  override val data: WebhookBillingKeyDataIssued,
) : WebhookBillingKey
